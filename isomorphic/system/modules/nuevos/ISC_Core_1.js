...
/*
  ...
  Version v8.2p_2012-07-26/EVAL Development Only (2012-07-26)
...
else isc._preLog=[isc._pTM]}isc.definingFramework=true;var isc=window.isc?window.isc:{};isc.$d=new Date().getTime();isc.version="v8.2p_2012-07-26/EVAL Development Only";isc.versionNumber="v8.2p_2012-07-26";isc.buildDate="2012-07-26";isc.expirationDate="2012.09.24_05.10.51";isc.licenseType="Eval";isc.licenseCompany="Isomorphic Software";isc.licenseSerialNumber="ISC_EVAL_NIGHTLY";isc.licensingPage="http://smartclient.com/product/";isc.$41r={SCServer:{present:"true",name:"SmartClient Server",serverOnly:true,isPro:true},Drawing:{present:"true",name:"Drawing Module"},PluginBridges:{present:"true",name:"PluginBridges Module"},RichTextEditor:{present:"true",name:"RichTextEditor Module"},Calendar:{present:"true",name:"Calendar Module"},Analytics:{present:"true",name:"Analytics Module"},Charts:{present:"true",name:"Charts Module"},Tools:{present:"${includeTools}",name:"Portal and Tools Module"},NetworkPerformance:{present:"true",name:"Network Performance Module"},FileLoader:{present:"true",name:"Network Performance Module"},RealtimeMessaging:{present:"true",name:"RealtimeMessaging Module"},serverCriteria:{present:"true",name:"Server Advanced Filtering",serverOnly:true,isFeature:true},customSQL:{present:"true",name:"SQL Templating",serverOnly:true,isFeature:true},chaining:{present:"true",name:"Transaction Chaining",serverOnly:true,isFeature:true},batchDSGenerator:{present:"true",name:"Batch DS-Generator",serverOnly:true,isFeature:true},batchUploader:{present:"true",name:"Batch Uploader",serverOnly:true,isFeature:true},transactions:{present:"true",name:"Automatic Transaction Management",serverOnly:true,isFeature:true}};isc.canonicalizeModules=function(_1){if(!_1)return null;if(isc.isA.String(_1)){if(_1.indexOf(",")!=-1){_1=_1.split(",");var _2=/^\s+/,_3=/\s+$/;for(var i=0;i<_1.length;i++){_1[i]=_1[i].replace(_2,"").replace(_3,"")}}else _1=[_1]}
...
);isc.B._maxIndex=isc.C+1;isc.A=isc.Class;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$cj={};isc.A.dontDup={StringBuffer:true,Action:true,MathFunction:true,JSONEncoder:true};isc.A.evalFrameResetInterval=100;isc.A.evalFrameHTML="<html><body><script>"+"var nativeObjTypes = ['Array', 'String', 'Date'];"+"for (var i = 0; i < nativeObjTypes.length; i++) {"+"var proto = window[nativeObjTypes[i]].prototype,"+"sourceProto = window.parent[nativeObjTypes[i]].prototype;"+"for (var attr in sourceProto) {"+"proto[attr] = sourceProto[attr];"+"}"+"}"+"window.isc = window.parent.isc;"+"function doEval(exp, args) {"+"try{"+"if (args) {"+"with (args) { "+"return eval(exp);"+"}"+"} else {"+"return eval(exp);"+"}"+"} catch (e) {"+"window.parent.isc.Log.logInfo("+"'Attempt to evaluate in eval-frame threw error:' + e "+"+ '. Attempting eval in main window.',"+"'iframeEval');"+"if (args) {"+"with (args) { "+"return window.parent.eval(exp);"+"}"+"} else {"+"return window.parent.eval(exp);"+"}"+"}"+"}"+"</script></body></html>";isc.A.$ck={};isc.A.fireOnPauseDelay=200;isc.A.$cl="$cm";isc.A.$cn={};isc.A.$co={};isc.A.useFastEvalWithVars=isc.Browser.isMoz&&isc.Browser.geckoVersion>=20061010;isc.A.$cp="ID";isc.A.getWindow=(isc.Browser.isSafari?function(){return window}:function(){return this.ns.$ch});isc.A.getDocument=(isc.Browser.isSafari?function(){return window.document}:function(){return this.ns.$ci});isc.B.push(isc.A.create=function isc_c_Class_create(_1,_2,_3,_4,_5,_6,_7,_8,_9,_10,_11,_12,_13){var _14=this.createRaw();_14=_14.completeCreation(_1,_2,_3,_4,_5,_6,_7,_8,_9,_10,_11,_12,_13);return _14}
...
if(this.evalFrame==null){this.makeEvalFrame()}
if(this.evalFrame.evalCount>this.evalFrameResetInterval){this.resetEvalFrame()}
return this.evalFrame.doEval(_1,_2)}
,isc.A.makeEvalFrame=function isc_c_Class_makeEvalFrame(){this.evalFrame=isc.HiddenFrame.create({doEval:function(_1,_2){this.evalCount++;return this.getHandle().doEval(_1,_2)}});this.evalFrame.draw();this.resetEvalFrame()}
...
this.evalFrame.evalCount=0;var _1=this.evalFrame.getFrameDocument();_1.open();_1.write(this.evalFrameHTML);_1.close()}
...
);isc.B._maxIndex=isc.C+171;isc.EventHandler.captureEvents();if("2012.09.24_05.10.51"!=""&&!"2012.09.24_05.10.51".startsWith("${")&&!window.isc_expirationOff&&new Date()>Date.parseStandardDate("2012.09.24_05.10.51"))
...
_2+=" for a renewal.";if(isc.Window){isc.Timer.setTimeout("isc.say('"+_2+"')",200)}else{isc.Timer.setTimeout("alert('"+_2+"')",200)}};isc.Page.setEvent("load","$nf()")}
isc.ClassFactory.defineClass("Element",null,null,true);isc.A=isc.Element;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$wq=window.isc_insertAfterBodyStart;isc.A.$wr="isc_global_insertion_marker";isc.A.$n7="afterBegin";isc.A.$n9="afterEnd";isc.A.$n6="beforeBegin";isc.A.$n8="beforeEnd";isc.A.$84e=(isc.Browser.isIE&&!isc.Browser.isIE9)||isc.Browser.isOpera;isc.A.$w2=isc.Browser.isMoz?"border-left-width":"borderLeftWidth";isc.A.$w3=isc.Browser.isMoz?"border-top-width":"borderTopWidth";isc.A.$oi=isc.Browser.isMoz?"margin-left":"marginLeft";isc.A.$ok=isc.Browser.isMoz?"margin-top":"marginTop";isc.A.$27r="none";isc.A.cacheCount=0;isc.A.uncachedCount=0;isc.A.$808="$808";isc.A.$809="$809";isc.A.cacheOffsetCoords=true;isc.A.$nk={};isc.A.$419={border:"borderStyle",borderWidth:"borderStyle",borderLeft:"borderLeftStyle",borderRight:"borderRightStyle",borderTop:"borderTopStyle",borderBottom:"borderBottomStyle",borderLeftWidth:"borderLeftStyle",borderRightWidth:"borderRightStyle",borderBottomWidth:"borderBottomStyle",borderTopWidth:"borderTopStyle"};isc.A.$nl={};isc.A.$39=";";isc.A.vendorCSSPrefix=(isc.Browser.isMoz?"-moz-":isc.Browser.isSafari?"-webkit-":isc.Browser.isOpera?"-o-":"");isc.B.push(isc.A.get=function isc_c_Element_get(_1,_2){_2=_2||this.getDocument();if(isc.Browser.isDOM)return _2.getElementById(_1)}
