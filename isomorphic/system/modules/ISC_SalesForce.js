...
,isc.A.ensureLoggedIn=function(_1,_2){if(this.sessionId)return this.fireCallback(_1);var _3=this;isc.showLoginDialog(function(_4,_5){if(_4==null)return;_3.login(_4.username,_4.password,function(_6){_5(_6);if(_6)isc.Class.fireCallback(_1)})},{title:"Please log in to SalesForce",dismissable:_2})}
