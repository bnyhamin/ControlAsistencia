...
,isc.A.find=function(_1,_2){var _3;if(_2===_3)return this.$27j(_1);if(_1==this.idField)return this.nodeIndex[_2];if(this.root[_1]==_2)return this.root;return this.getDescendants().find(_1,_2)}
...
,isc.A.add=function(_1,_2,_3){if(isc.isA.String(_2))_2=this.find(_2);if(!_2){var _4=this.getParentPath(_1);if(_4)_2=this.find(_4);if(!_2)return false}
this.$27e(_1,_2,_3);this.$27f();this.dataChanged();return _1}
,isc.A.$27e=function(_1,_2,_3){this.getName(_1);this.convertToFolder(_2);var _4=_2[this.childrenProperty];if(!_4)_4=_2[this.childrenProperty]=[];if(_4!=null&&!isc.isAn.Array(_4))
...
_7=isc.booleanValue(_7,true);if(_7==null&&this.defaultIsFolder)_7=true;_1[this.isFolderProperty]=_7}}
...
,isc.A.$27k=function(_1,_2,_3){for(var i=0,_5=_1.length;i<_5;i++)
this.$27e(_1[i],_2,_3!=null?_3++:null)}
...
this.lastSelectionItem=_1;this.lastSelectionState=_2;if(_2==_5)return false;this.markForRedraw();return true}
...
return _2.toString()}}
,isc.A.getBlockHTML=function(_1){var _2=_1.getLength();var _3="<TABLE WIDTH="+this.getInnerWidth()+" CELLPADDING="+this.cellPadding;if(this.showBorder){_3+=(isc.Browser.isIE?" CELLSPACING=1 BORDER=0 STYLE='background-color:gray;'":" CELLSPACING=0 BORDER=1")}
...
,isc.A.output_value=function(_1,_2,_3){var _4="<TD WIDTH=10% CLASS='"+this.labelStyle+"' ALIGN=RIGHT"+(this.wrapLabel?">":" NOWRAP><NOBR>")+this.labelPrefix+(_2.title?_2.title:_2[this.fieldIdProperty])+this.labelSuffix+"<\/NOBR><\/TD>";if(_2.valueMap&&isc.isA.String(_2.valueMap))
...
return _4}
,isc.A.getCellValue=function(_1,_2){var _3=_1[_2[this.fieldIdProperty]];if(isc.isA.String(_2.formatCellValue)){_2.formatCellValue=isc.Func.expressionToFunction("value, record, field",_2.formatCellValue)}
if(_2.getCellValue!=null){if(isc.isA.String(_2.getCellValue)){_2.getCellValue=isc.Func.expressionToFunction("value, record, field",_2.getCellValue)}
_3=_2.getCellValue(_3,_1,_2);if(_2.formatCellValue)_3=_2.formatCellValue(_3,_1)}else{if(_2.valueMap!=null)_3=isc.getValueForKey(_3,_2.valueMap);if(_2.formatCellValue)_3=_2.formatCellValue(_3,_1);if(_3==null||isc.is.emptyString(_3))_3=this.emptyCellValue}
if(this.formatCellValue){_3=this.formatCellValue(_3,_1,_2)}else{_3=this.$17c(_1,_2,_3);if(_2.asHTML)_3=_3.asHTML()}
return _3}
...
,isc.A.output_header=function(_1,_2,_3){return"<TD COLSPAN="+(_3.getLength()+1)+" CLASS='"+this.headerStyle+"'>"+_2.value+"</TD>"}
...
return _3}
,isc.A.getDrawArea=function(_1){var _2=this.getTotalRows(),_3,_4,_5;if(this.showAllRows){_3=0;_4=_2-1}else{var _6=this.$27x();_5=(this.lastScrollTop==null?null:this.lastScrollTop<this.getScrollTop());var _7=this.addDrawAhead(_6[0],_6[1],_2,_5,true);_3=_7[0];_4=_7[1]}
...
if(this.cacheDOM&&!this.$508){this.$508=_4-_3;this.$509=_9-_8}
return[_3,_4,_8,_9]}
...
,isc.A.scrollToRatio=function(_1,_2,_3,_4){if(!_1||!this.virtualScrolling){return this.invokeSuper(isc.GridRenderer,"scrollToRatio",_1,_2,_3,_4)}
...
,isc.A.getScrollRatio=function(_1,_2,_3,_4){if(!_1||!this.virtualScrolling){return this.invokeSuper(isc.GridRenderer,"getScrollRatio",_1,_2,_3,_4)}
...
,isc.A.getViewportRatio=function(_1,_2,_3,_4){if(!_1||!this.virtualScrolling){return this.invokeSuper(isc.GridRenderer,"getViewportRatio",_1,_2,_3,_4)}
var _5=this.$272||this.avgRowHeight;return Math.min(1,(this.getViewportHeight()/_5)/this.getTotalRows())}
,isc.A.$273=function(_1,_2){if(this.$274)return;var _3
...
,isc.A.scrollTo=function(_1,_2,_3,_4){if(isc.$cv)arguments.$cw=this;if(this.virtualScrolling&&_2!=null&&!_3){var _5=this.getScrollTop(),_6=_2-_5;this.$273(_5,_6);_2=Math.min(_2,this.getRowTop(this.getTotalRows()-1))}
...
,isc.A.$28b=function(_1,_2,_3,_4,_5){this.$28c=_2;this.$28e=_3;var _6=0;if(!_1){var _7=this.$26b();for(var i=_2;i<_3;i++){_6+=_7[i]}
...
if(this.isDirty())this.redraw("Initializing row animation requires second redraw");this.$28h={callback:_4,target:(_5?this.parentElement:this)};return _6}
...
,isc.A.getTableHTML=function(_1,_2,_3){var _4=isc.timeStamp();if(this.isEmpty()){this.$252=this.$253=this.$254=this.$255=null;return this.$27w()}
...
var _14=_13-_12;var _15=(this.showAllColumns||_1!=null);var _16=isc.StringBuffer.create(),_17=this.fields,_18=this.$26a;this.$28r=_12!=0?null:this.$26a[0];var _19,_20,_21,_22;if(!_15){_19=this.$26a.slice(0,_12).sum(),_20=this.$26a.slice(_13,this.$26a.length).sum(),_21=this.$26a.sum()
_22=(this.cacheDOM||isc.Browser.isIE||isc.Browser.isSafari?"margin":"padding")}
...
var _26=this.startSpace||0;if(_2!=_6){var _27=((_2-_6)*this.avgRowHeight);this.$514=_27;_26+=_27}else{this.$514=0}
if(!this.cacheDOM){_16.append("<DIV style='height:",_26,"px;overflow:hidden;",(_26==0?"display:none;":null),"' ",(_5?">":" ID="+this.getID()+"$28s>"),isc.Canvas.spacerHTML(1,_26),"</DIV>")}
_16.append("<TABLE BORDER=0",_25,(!_5?" ID="+this.getTableElementId():null),(this.tableStyle&&isc.Browser.isDOM?" CLASS='"+this.tableStyle+this.$ob:isc.$ad)," CELLSPACING=",this.cellSpacing," CELLPADDING=",this.cellPadding," STYLE='",(isc.Browser.isDOM&&!_24&&this.fixedColumnWidths?"table-layout:fixed;overflow:hidden;wrap:false;":""),(!_15?_22+(this.isRTL()?"-right: ":"-left:")+_19+"px;"+_22+(this.isRTL()?"-left:":"-right:")+_20+"px;":""),(this.cacheDOM&&this.$514>0?"margin-top:"+this.$514+"px;":""),(this.$27y!=null&&!(isc.Browser.isIE&&this.$r9)?"visibility:hidden;":""),"'>",(isc.Browser.isMoz?"<TBODY>":""));var _28=0,_29=0,_30=this.$54p();if((isc.Browser.isSafari||isc.Browser.isIE)&&isc.Browser.isStrict){_29=this.$54q();_28=(this.fixedRowHeights?0:this.cellPadding*2);_28+=(this.fixedRowHeights?isc.Element.$ym(_30):isc.Element.$yo(_30))}
this.$28t=_28;this.$28u=_29;if(!_24&&isc.Browser.isDOM){for(_1=_12;_1<_13;_1++){_16.append("<COL WIDTH=",(_18[_1]-_29),">")}}
_16.append("<TBODY>");var _31=this.cellHeight,_32=(this.wrapCells?"":"<NOBR>"),_33=(this.wrapCells?"":"</NOBR>");var _34=0;if(isc.Browser.isDOM){var _35=this.$28v(_31);var _36=[];_36[0]="<TD";_36[3]=" ALIGN=";_36[17]=this.fastCellUpdates?"' ":"' CLASS=";if(!_5&&this.getCellElementId)_36[19]=" ID=";_36[23]=">"+_32;_36[30]=_33+(_35?"</DIV></TD>":"</TD>");var _37=1,_38=2,_39=4,_40=5,_41=6,_42=7,_43=10,_44=11,_45=18,_46=20,_47=21,_48=24;var _49="<TR>",_50="</TR>",_51=" HEIGHT=",_52=" VALIGN=";if(isc.screenReader)_49="<TR tabIndex=-1>";var _53=[],_54=0,_55=[];var _56=" COLSPAN="+_14+" STYLE='"+(this.fixedRowHeights?"padding-top:0px;padding-bottom:0px;":"");this.$50d(_12,_13,_24,_29,_35);for(var _57=_2;_57<_3;_57++){var _58=(!_5&&this.$28c==_57);var _59=this.getCellRecord(_57);var _60=_58||this.$282(_57,_59);if(!_5&&this.getRowElementId){_16.append("<TR",(isc.screenReader?" tabIndex=-1":null)," ID=",this.getRowElementId(_57,_57-_2),">")}else{_16.append(_49)}
if(this.fixedRowHeights||_35){var _61=_58?this.$28f:(this.getRowHeight!=null?this.getRowHeight(_59,_57):_31),_62=_58||(this.shouldFixRowHeight==null||this.shouldFixRowHeight(_59,_57)!=false);if(_62){_36[_37]=_51;_36[_38]=_61-_28;_36[_43]=null}else{_36[_37]=null;_36[_38]=null;_36[_43]=this.$281(_59,_57)}
if(_35){_36[_47]=">"+this.$27s+this.$283(_61,_59,_57,_58)}}
for(_1=_12;_1<_13;_1++){var _63=_17[_1];if(_53[_1]>0){_63.$28w[_57]=_55[_1];_53[_1]--;if(_53[_1]==0){_54--;_55[_1]=null}
continue}
if(this.grid&&this.grid.getCellAlign!=null){_36[_39]=this.grid.getCellAlign(_59,_57,_1)}else{_36[_39]=(_63.cellAlign||_63.align)}
if(this.grid&&this.grid.getCellVAlign!=null){_36[_40]=_52
_36[_41]=this.grid.getCellVAlign(_59,_57,_1)}
if(_60){_34++;_36[_42]=_56;if(_35){_36[_47+1]=this.$ob}}else{_36[_42]=_63.$28x;if(this.getRowSpan){var _64=this.getRowSpan(_59,_57,_1);if(_64>1){var _65=" ROWSPAN="+_64;if(_36[_39]!=null)
_36[_39]+=_65;else
_36[_39]=_65;_53[_1]=_64-1;_54++;_55[_1]=_57;if(_63.$28w==null)_63.$28w={};_63.$28w[_57]=_57}}
if(_35){_36[_47+1]=_63.$28y}else{_36[_47+1]=null}}
var _66=this.getCellStyle(_59,_57,_1),_67=(this.getCellCSSText?this.getCellCSSText(_59,_57,_1):null);if(_58){var _68="padding:0px;border:0px;";if(_67)_67+=";"+_68
else _67=_68}
if(!this.fastCellUpdates){_36[_44]=_67
_36[_45]=_66}else{_36[_44]=isc.Element.getStyleText(_66,true);_36[_44+1]=_67}
if(_58){this.$28q=true;var _69=this.getTableHTML(null,this.$28c,this.$28e);delete this.$28q;if(!_35){_36[_48]=isc.SB.concat(this.$27s,this.$283(_61,_59,_57,_58),this.$ob,this.$oa,_69,"</DIV>")}else{_36[_48]=_69}}else
_36[_48]=this.$22k(_59,_57,_1);if(!_5&&this.getCellElementId){_36[_46]=this.getCellElementId(_57,_57-_2,_1,_1-_12)}
_16.append(_36);if(_60)break}
_16.append(_50);if(_58){_57=this.$28e-1}}}
_16.append("</TABLE>");var _70=_7-_3,_71=(!_5&&this.virtualScrolling);var _72=this.cacheDOM?0:(this.endSpace||0);this.$515=0;if(!this.showAllRows&&(_70!=0||(_71&&_70==0&&(this.overflow=="auto"||this.overflow=="scroll"))))
{var _73=_70*this.avgRowHeight;if(_71&&_70==0){var _74=this.getViewportHeight();if(_73<_74){_73=_74}}
this.$515=_73;_72+=this.$515}
if(!this.cacheDOM){_16.append("<DIV STYLE='overflow:hidden;width:1px;height:",_72,"px;",(_72==0?"display:none;":null),(_5?"'>":"' ID="+this.getID()+"$284>"),isc.Canvas.spacerHTML(1,_72),"</DIV>")}
if(this.logIsDebugEnabled("gridHTML")){var _75=(isc.timeStamp()-_4),_76=((_13-_12)*(_3-_2)),_77=(_75/ _76),_78=(1000/_77);if(_77.toFixed!=null)_77=_77.toFixed(2);if(_78.toFixed!=null)_78=_78.toFixed(2);this.logDebug("getTableHTML: columns "+_12+"->"+(_13-1)+", rows "+_2+"->"+(_3-1)+", time: "+_75+"ms ("+_76+" cells at "+_77+"ms per cell, "+_78+" cells per second), "+"spacerHeights: ["+[_26,_72]+"], "+_34+" single cell rows","gridHTML")}
return _16.release()}
,isc.A.$54p=function(){return(this.getBaseStyle!=null?this.getBaseStyle(this.getCellRecord(0,0),0,0):this.baseStyle)}
,isc.A.$50d=function(_1,_2,_3,_4,_5){var _6=this.fields,_7=this.$26a;for(var _8=_1;_8<_2;_8++){var _9=_6[_8];_9.$28w=null;if(_3){_9.$28x=(isc.Browser.isIE?" STYLE='":" STYLE='OVERFLOW:hidden;");_9.$28y=this.$ob}else{_9.$28x=(isc.Browser.isIE?" WIDTH="+(_7[_8]-_4)+" STYLE='":" STYLE='"+this.$28z(_8));if(_5){_9.$28y=this.$280(_8)+this.$ob}}
...
,isc.A.$22k=function(_1,_2,_3){var _4=this.getCellValue(_1,_2,_3,this);if(_1&&_1.$288){_4+="<BR>"+isc.Canvas.spacerHTML(1,_1.$288.getVisibleHeight())}
return _4}
...
if(this.$276()||this.$277())return true;return false}
,isc.A.getRowHeight=function(_1,_2){var _3=this.updateHeightForEmbeddedComponents(_1,_2,this.cellHeight);return _3}
,isc.A.updateHeightForEmbeddedComponents=function(_1,_2,_3){if(_1&&_1.$288){var _4=_1.$288
if(isc.isA.Canvas(_4)){_4.$289=_2;_3+=_4.getVisibleHeight()}}
return _3}
...
{_5++;_6++}
return _6}
,isc.A.addEmbeddedComponent=function(_1,_2){if(!isc.isA.Canvas(_1)){_1.autoDraw=false;var _3=isc.ClassFactory.getClass(_1._constructor);if(_3==null)_3=isc.Canvas;_1=_3.create(_1)}
...
_2.$288=_1;if(this.$29a==null)this.$29a=[];this.$29a.add(_1);_1.hide();this.addChild(_1);this.observe(_1,"resized","if(deltaY!=null&&deltaY!=0)observer.markForRedraw('embedded component resized')");_1.$29b=_1.$nu;_1.$nu=false;this.markForRedraw("added embedded component")}
,isc.A.placeEmbeddedComponent=function(_1){var _2=_1.$289;if(_2==null||_2<this.$252||_2>this.$253){_1.hide()}else{_1.setTop(this.getRowTop(_2)+this.cellHeight);_1.show();_1.bringToFront()}}
,isc.A.removeEmbeddedComponent=function(_1){if(isc.isA.Number(_1))_1=this.getCellRecord(_1,0);var _2=_1.$288;if(_2==null)return;this.ignore(_2,"resized");_1.$288=null;this.$29a.remove(_2);_2.$nu=_2.$29b;_2.$29b=null;_2.destroy();this.markForRedraw("removed embedded component")}
...
,isc.A.getRowTop=function(_1){if(_1<this.$252)return this.avgRowHeight*_1;var _2=this.$29n(),_3=this.$26b();if(_1>this.$253){return _2+_3.sum()+(((_1-1)-this.$253)*this.avgRowHeight)}
...
,isc.A.getRowSize=function(_1){if(_1<this.$252||_1>this.$253)return this.avgRowHeight;var _2=_1-this.$252,_3=this.$26b();return _3[_2]}
...
,isc.A.$29n=function(){return this.$252*this.avgRowHeight}
...
);isc.evalBoundary;isc.B.push(isc.A.getColumnSizes=function(){if(this.$29o!=null)return this.$29o;if(this.fixedColumnWidths&&isc.Browser.version>=5){return(this.$29o=this.$26a.duplicate())}else{var _1=this.$29o=[];var _2=this.getTableElement(this.$252);if(_2==null){this.$29o=_1.concat(this.$26a);return this.$29o}
...
return _1}
,isc.A.$27x=function(){if(this.virtualScrolling&&this.$27y!=null){var _1=this.$27y;if(this.$27z<0)_1+=Math.floor(this.$27z/ this.cellHeight);if(_1<0)_1=0;var _2=_1+Math.ceil(this.getViewportHeight()/this.cellHeight);return[_1,_2]}
var _3=Math.floor(this.getScrollTop()/this.avgRowHeight),_4=_3+Math.ceil(this.getViewportHeight()/this.cellHeight);if(this.startSpace){var _5=Math.floor(this.startSpace/ this.avgRowHeight);_3=Math.max(0,_3-_5);_4=Math.max(0,_4-_5)}
return[_3,_4]}
...
,isc.A.mouseMove=function(_1,_2){if(this.$29p())return;var _3=this.getEventRow(),_4=this.getEventColumn();if(_3==this.lastOverRow&&_4==this.lastOverCol)return false;var _5,_6=(_3!=this.lastOverRow||_4<0);if(this.lastOverRow!=null&&this.lastOverCol!=null){var _7=this.lastOverRow,_8=this.lastOverCol,_9=this.getCellRecord(_7,_8);this.lastOverRow=null;this.lastOverCol=null;if((this.hoverByCell||_6)&&this.shouldShowRollOver(_7,_8))
{this.updateRollOver(_7,_8);if(this.getCanHover()&&!this.keepHoverActive)this.stopHover()}
if(this.cellOut){this.cellOut(_9,_7,_8)}
if(_6&&this.rowOut){this.rowOut(_9,_7,_8)}}
if(_3>=0&&_4>=0&&this.cellIsEnabled(_3,_4)){this.lastOverRow=_3;this.lastOverCol=_4;if(this.hoverByCell||_6){if(this.shouldShowRollOver(_3,_4)){this.updateRollOver(_3,_4)}
...
,isc.A.mouseOut=function(){if(this.getCanHover())this.stopHover();if(this.lastOverRow!=null&&this.lastOverCol!=null){var _1=this.lastOverRow,_2=this.lastOverCol,_3=this.getCellRecord(_1,_2);this.lastOverRow=null;this.lastOverCol=null;if(this.shouldShowRollOver(_1,_2)){this.updateRollOver(_1,_2)}
if(this.cellOut){this.cellOut(_3,_1,_2)}
if(this.rowOut){this.rowOut(_3,_1,_2)}}}
...
,isc.A.$29r=function(_1,_2,_3){var _4=this.$wc();isc.Hover.show(this.cellHoverHTML(_1,_2,_3),_4,this.cellHoverBoundary(_2,_3))}
...
,isc.A.$29t=function(_1,_2){if(this.selectionChanged&&(this.selectionChanged(_1,_2)==false))return false;var _3=this.selection,_4=_3.lastSelectionItem,_5=_3.data.indexOf(_4,this.$252,this.$253);if(_5==-1)_5=_3.data.indexOf(_4);if(_5==-1)return;this.setRowStyle(_5)}
...
,isc.A.selectOnMouseDown=function(_1,_2,_3){if(!this.selectionEnabled())return true;if(_2>=0&&_3>=0)this.selection.selectOnMouseDown(this,_2,_3)}
...
var _3=this.getPageLeft()+this.getLeftBorderSize()-this.getScrollLeft(),_4=_1-_3;var _5=this.ns.EH,_6=_2||this.snapHDirection,_7=this.getEventColumn(_4),_8=this.getColumnLeft(_7),_9=this.getColumnLeft(_7)+this.getColumnSize(_7),_10=this.getEventColumn(_9+1),_11;if(_10>=0){_11=this.getColumnLeft(_10)}else{_11=_8}
var _12=_8+this.getColumnSize(_7)/2;_8+=_3;_11+=_3;_9+=_3;if(this.snapInsideBorder){var _13=isc.Element.$tl(this.baseStyle)
var _14=isc.Element.$tm(this.baseStyle)
_8+=_13;_9-=_14;_11+=_13}
if(_5.dragOperation==_5.DRAG_RESIZE){var _15=_1<_5.dragTarget.getPageLeft();return _15?_8:_9}else{if(_6==isc.Canvas.BEFORE){return _8}else if(_6==isc.Canvas.AFTER){return _11}else{if(_4<=_12){return _8}else{return _11}}}}
,isc.A.getVSnapPosition=function(_1,_2){if(!this.snapToCells){return this.Super("getVSnapPosition",arguments)}
var _3=this.getPageTop()+this.getTopBorderSize()-this.getScrollTop(),_4=_1-_3;var _5=this.ns.EH,_6=_2||this.snapVDirection,_7=this.getEventRow(_4),_8=this.getRowTop(_7),_9=this.getRowTop(_7)+this.getRowSize(_7),_10=this.getEventRow(_9+1),_11;if(_10>=0){_11=this.getRowTop(_10)}else{_11=_8}
var _12=_8+this.getRowSize(_7)/2;_8+=_3;_9+=_3;_11+=_3;if(this.snapInsideBorder){var _13=isc.Element.$tn(this.baseStyle)
var _14=isc.Element.$to(this.baseStyle)
_8+=_13;_9-=_14;_11+=_13}
if(_5.dragOperation==_5.DRAG_RESIZE){var _15=_1<_5.dragTarget.getPageTop();return _15?_8:_9}else{if(_6==isc.Canvas.BEFORE){return _8}else if(_6==isc.Canvas.AFTER){return _11}else{if(_4<=_12)return _8;else return _11}}}
...
,isc.A.redraw=function(_1,_2,_3,_4){this.$29c();if(!this.cacheDOM)this.$29j();this.invokeSuper(isc.GridRenderer,"redraw",_1,_2,_3,_4);delete this.$50v;this.$29d()}
...
if(this.virtualScrolling){var _2=this.$26b().sum();if(_2<this.getViewportHeight()){this.$515=1;var _3=isc.Element.get(this.getID()+"$284"),_4=this.$515+(this.endSpace||0);if(_3){if(_4==0)_3.style.display="none"
...
,isc.A.redraw=function(_1,_2,_3,_4){var _5=this.grid,_6=_5.$286,_7=_5.$30a,_8,_9,_10,_11,_12;if(!_5.leaveScrollbarGap&&_5.predictScrollbarGap&&(this.overflow==isc.Canvas.AUTO)){var _13=this.vscrollOn,_14=!_5.isEmpty()&&(_5.getTotalRows()*_5.cellHeight)>this.getInnerHeight();if(_13!=_14){_5.$45m("body redrawing with changed vertical scroll-state")}}
...
_5.$30b(null,true,this);_5.updateEditRow(_5.getEditRow());if(_6.hasFocus){this.$518(_8)}else{delete this.$519}}else if(_6!=null){_5.$30b(null,null,this)}}
...
_2.$10u=true}
,isc.A.$518=function(_1){var _2=this.grid,_3=_2.getEditForm(),_4=_3.getItem(_2.getEditorName(_2.getEditRow(),_1));if(_4!=null){_3.$11b(_4);if(this.$519[0]!=null)
_4.setSelectionRange(this.$519[0],this.$519[1])}}
,isc.A.isDirty=function(_1,_2,_3){return this.invokeSuper(null,"isDirty",_1,_2,_3)||this.grid.isDirty()}
,isc.A.shouldShowRollOver=function(_1,_2,_3,_4){if(!this.grid.showRollOver||this.$28j)return false;var _5=this.grid;if(_5.$30a&&!_5.editByCell&&_1==_5.$285)return false;if(this.$29a&&this.$29a.length>0){var _6=this.getCellRecord(_1,_2);if(_6&&_6.$288)return false}
return true}
,isc.A.updateRollOver=function(_1,_2){var _3=this.grid;this.setRowStyle(_1,null,(this.useCellRollOvers?_2:null));var _4=(this==_3.body?_3.frozenBody:_3.body);if(_4){_4.lastOverRow=this.lastOverRow;_4.lastOverCol=this.lastOverCol;_4.setRowStyle(_1,null,(this.useCellRollOvers?_2:null))}}
...
,isc.A.getEmptyMessageHTML=function(_1,_2,_3,_4){var _5=this.invokeSuper(null,"getEmptyMessageHTML",_1,_2,_3,_4);var _6=this.grid.getUnfrozenSlots(this.grid.getFieldWidths()).sum()-
this.getWidth()+(this.grid.leaveScrollbarGap?this.getScrollbarSize():0);if(_6>0){_5=isc.StringBuffer.concat("<TABLE CELLPADDING=0 CELLSPACING=0><TR><TD>",_5,"</TD><TD>",isc.Canvas.spacerHTML(_6,1),"</TD></TR></TABLE>")}
return _5}
...
delete this.$34y}
);isc.B._maxIndex=isc.C+29;isc.A=isc.ListGrid;isc.A.CORNER="corner";isc.A.FIELD="field";isc.A.COPY="copy";isc.A.MOVE="move";isc.A.CLONE="clone";isc.A.AFTER="after";isc.A.BEFORE="before";isc.A.OVER="over";isc.A.CLICK_OUTSIDE="click_outside";isc.A.CLICK="click";isc.A.DOUBLE_CLICK="doubleClick";isc.A.ENTER_KEYPRESS="enter";isc.A.ESCAPE_KEYPRESS="escape";isc.A.UP_ARROW_KEYPRESS="arrow_up";isc.A.DOWN_ARROW_KEYPRESS="arrow_down";isc.A.LEFT_ARROW_KEYPRESS="arrow_left";isc.A.RIGHT_ARROW_KEYPRESS="arrow_right";isc.A.TAB_KEYPRESS="tab";isc.A.SHIFT_TAB_KEYPRESS="shift_tab";isc.A.EDIT_FIELD_CHANGE="field_change";isc.A.EDIT_ROW_CHANGE="row_change";isc.A.PROGRAMMATIC="programmatic";isc.A.FOCUS="focus";isc.A.$295=["selection","selectionType","canSelectCells","canDragSelect","canSelectOnRightMouse","canDrag","canAcceptDrop","canDrop","autoFit","wrapCells","cellSpacing","cellPadding","cellHeight","enforceVClipping","showAllColumns","drawAheadRatio","quickDrawAheadRatio","scrollRedrawDelay","animateRowsMaxTime","fastCellUpdates","showRollOver","useCellRollOvers","canHover","showHover","hoverDelay","hoverWidth","hoverHeight","hoverAlign","hoverVAlign","hoverStyle","hoverOpacity","hoverMoveWithMouse","hoverByCell","keepHoverActive","cellHoverOutset","showEmptyMessage","emptyMessageStyle","emptyMessageTableStyle","singleCellValueProperty","isSeparatorProperty","accessKey","canFocus","_useNativeTabIndex","tableStyle","baseStyle","recordCustomStyleProperty","showFocusOutline"];isc.A.$296=["getCellStyleName","getCellStyleIndex","getRowTop","getRowPageTop","getRowSize","getCellPageRect","getVisibleRows","getDrawnRows","addEmbeddedComponent","removeEmbeddedComponent"];isc.A.$297=["getTotalRows","isEmpty","cellIsEnabled","willAcceptDrop","scrolled","getTableElementId","getRowElementId","getCellElementId","shouldFixRowHeight","getEmptyMessage","getCanHover","stopHover"];isc.A=isc.ListGrid;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.makeBodyMethods=function(_1){var _2=this.$cf;if(_2==null){_2=this.$cf=[,"return this.grid.",,"(",,")"]}
...
);isc.B._maxIndex=isc.C+14;isc.A=isc.ListGrid.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$g2="boolean";isc.A.$301="false;";isc.A.$18r="false";isc.A.$302="<HR>";isc.A.$303=["style='margin-left:",,"px;margin-right:",,"px;'"];isc.A.$g2="boolean";isc.A.$gx="text";isc.A.$54y={" ":true,"\n":true,"\r":true,"\r\n":true};isc.A.$54t="&nbsp;";isc.A.$20s="Arrow_Up";isc.A.$20t="Arrow_Down";isc.A.$304="Space";isc.A.$10j="Enter";isc.A.$51g="f2";isc.A.$20w="Escape";isc.A.$51h="Backspace";isc.A.$51i="Delete";isc.A.$51l="keyPress";isc.A.$27r="none";isc.A.$305="focus";isc.A.$12b="select";isc.A.$306="activate";isc.A.$kn=false;isc.A.$307={time:true,TimeItem:true};isc.A.$g5="time";isc.A.$308={date:true,dateTime:true,DateItem:true};isc.A.$g4="date";isc.A.$309={popUpTextArea:true,PopUpTextAreaItem:true};isc.A.$31a={checkbox:true,CheckboxItem:true};isc.A.$g2="boolean";isc.A.$12c="checkbox";isc.A.$12i="CycleItem";isc.A.$31b={select:true,SelectItem:true};isc.A.$45k=["change","changed","defaultDynamicValue"];isc.A.$31c=["change","changed","defaultDynamicValue","keyPress","click","showIf","enableIf"];isc.A.$31d={};isc.A.$31e=0;isc.A.$31f="rowNum,colNum,editCompletionEvent,success";isc.A.dragTrackerStyle="gridDragTracker";isc.A.headerMenuButtonDefaults={snapTo:"R",canFocus:false,title:null,iconSpacing:0,click:function(){this.parentElement.grid.headerMenuButtonClick()},mouseOut:function(){var _1=isc.EH.getTarget();if(!_1||!this.parentElement.contains(_1))this.hide();this.Super("mouseOut",arguments)}};isc.A.predictScrollbarGap=true;isc.A.sortFieldAscendingText="Sort Ascending";isc.A.sortFieldDescendingText="Sort Descending";isc.A.fieldVisibilitySubmenuTitle="Columns";isc.A.ungroupText="Ungroup";isc.A.$31g="sort";isc.A.chartConstructor="FusionChart";isc.A.groupIconPadding=5;isc.A.$31h={canDragSelect:true,canDragRecordsOut:true,canReorderRecords:true,canAcceptDroppedRecords:true};isc.A.$45l={bodyBackgroundColor:"backgroundColor",bodyStyleName:"styleName",fixedRecordHeights:"fixedRowHeights",fixedFieldWidths:"fixedColumnWidths",alternateRecordStyles:"alternateRowStyles",alternateRecordFrequency:"alternateRowFrequency",showAllRecords:"showAllRows"};isc.B.push(isc.A.initWidget=function(){if(this.loadingMessage==null||this.loadingMessage==isc.emptyString)
this.loadingMessage="&nbsp";this.setData(this.data?null:this.getDefaultData());if(this.groupByField){var _1;if(isc.isA.Array(this.groupByField))_1=this.groupByField;else _1=[this.groupByField];this.groupByField=null;this.groupBy(_1)}
this.$31i()}
...
,isc.A.isEmpty=function(){if(!this.data)return true;if(isc.ResultSet&&isc.isA.ResultSet(this.data)){if(this.data.isPaged()){if(!this.data.isEmpty())return false;var _1=this.getAllEditRows();if(_1&&_1.length>0){for(var i=0;i<_1.length;i++){if(_1[i]>=0)return false}}
return true}else{if(this.data.lengthIsKnown())return this.getTotalRows()<=0;else return true}}else{return(this.getTotalRows()<=0)}}
,isc.A.setData=function(_1){if(this.data==_1)return;if(!this.preserveEditsOnSetData)this.discardAllEdits();if(this.data){this.$31j(this.data);if(this.data.$31k&&isc.isA.Function(this.data.destroy))
this.data.destroy()}
if(_1)this.data=_1;if(!this.data)return;this.$31m(this.data);this.regroup(true);if(!this.selection||(this.data!=this.selection.data)){this.$31l()}
if(this.preserveEditsOnSetData)this.$31n();if(this.canSort&&this.sortFieldNum!=null){this.sortData()}
if(isc.ResultSet&&isc.isA.ResultSet(this.data)&&this.body&&this.body.overflow=="visible")
{this.body.showAllRows=false}
this.$25a("setData")}
,isc.A.$31l=function(){if(this.canSelectCells){var _1=[];if(this.numRows!=null){for(var i=0;i<this.numRows;i++){_1[i]={}}}}else{var _1=this.data}
var _3,_4={ID:this.getID()+"_selection",data:_1,selectionProperty:this.selectionProperty,simpleDeselect:this.simpleDeselect,dragSelection:this.canDragSelect};if(this.canSelectCells&&this.fields!=null)_4.numCols=this.fields.length;if(this.data.getNewSelection){_3=this.data.getNewSelection(_4)}
if(_3==null){if(this.canSelectCells){_3=isc.CellSelection.create(_4)}else{_3=isc.Selection.create(_4)}}
if(isc.isA.Canvas(this.body)){this.body.setSelection(_3);if(this.frozenBody)this.frozenBody.setSelection(_3)}
this.selection=_3}
...
var _4=this.getRecord(this.getEditRow());if(this.data.isDescendantOf(_4,_1))this.endEditing();if(this.animateFolders)
...
,isc.A.$340=function(_1){var _2=this.data,_3=_2.indexOf(_1),_4=_2.getOpenList(_1).getLength()-1;if(_3<0||_4<=0)return;this.startRowAnimation(true,_3+1,(_3+_4+1),{target:this.body,methodName:"redraw"},this.animateFolderSpeed,this.animateFolderTime,this.animateFolderEffect,true)}
,isc.A.dataChanged=function(_1,_2,_3,_4){var _5=this.groupByField;if(_5!=null){if(_3!=null&&_2==null){this.$52y=true}else if(_1=="update"&&_2!=null){if(!isc.isAn.Array(_5))_5=[_5];var _6;if(this.data.isGroupedOutput&&this.originalData)_6=this.originalData;else _6=this.data;var _7=_6.get(_3);for(var i=0;i<_5.length;i++){var _9,_10=_5[i];if(_2[_10]!==_9&&!this.fieldValuesAreEqual(_10,_2[_10],_7[_10]))
{this.$52y=true;break}}}}
...
if(this.$31q>_11)delete this.$31q;if(!this.$50w)this.$25a("dataChanged")}
...
,isc.A.$31s=function(_1){var _2=_1.type,_3=(_2!=null?isc.SimpleType.getBaseType(_2):null);if(_3!=this.$g2)return false;return(!_1.suppressValueIcons&&_1.showValueIconOnly==null&&_1.valueIcons==null&&_1.valueMap==null&&_1.formatCellValue==null)}
,isc.A.setFieldProperties=function(_1,_2){_1=this.getFieldNum(_1);var _3=this.getField(_1);isc.addProperties(_3,_2);if(this.header!=null&&this.header.isDrawn()){this.header.getMember(_1).setProperties(_2)}}
...
if(!_4||this.frozenFields||_3.frozen||this.$54d){this.setFields(this.completeFields||this.fields);return}else{if(this.fields.contains(_3))return;this.deriveVisibleFields()}
...
if(this.$30a&&!this.editByCell||this.getEditCol()==_5){var _7=this.getEditRow(),_8=this.getRecord(_7),_9=this.getEditedRecord(_7),_10=this.getEditFormItemFieldWidths(_8)[_5],_11=this.getEditItem(_3,_8,_9,_7,_5,_10);if(_11!=null){var _12;if(this.editByCell)_12=0;else{var _13=this.$286.getItems();for(var i=0;i<_13.length;i++){var _15=_13[i].colNum;if(_15>=_5){if(_12==null)_12=i;_13[i].colNum+=1}}}
var _16=this.body.getDrawArea();if(this.editByCell||_5>=_16[2]&&_5<=_16[3])
this.$286.addItems([_11],_12)}}
...
_8=-1;if(_8==-1){var _11;if(!this.editByCell)_11=this.findNextEditCell(_4,0,1,true,true,false,true);if(_11!=null&&_11[0]==_4){_8=_11[1]}
...
if(this.sortFieldNum!=null&&this.canSort)this.resort();if(this.filterEditor!=null)this.filterEditor.setFields(this.completeFields.duplicate())}
...
,isc.A.evalViewState=function(_1,_2,_3){if(isc.isA.String(_1)){var _4=_1;try{_1=eval(_1)}catch(e){if(!_3)
this.logWarn("Unable to parse "+_2+" object passed in: "+_4+" Ignoring.");return}}
return _1}
,isc.A.setFieldState=function(_1){if(this.completeFields==null)return;if(_1==null&&this.fieldState!=null){this.$31y(this.fieldState);this.fieldState=null;return}
...
,isc.A.getSortState=function(){var _1=(this.sortFieldNum!=null?this.getField(this.sortFieldNum):null),_2=_1!=null?this.getFieldName(_1):null,_3=_1&&_1.sortDirection!=null?_1.sortDirection:this.sortDirection;return"("+isc.Comm.serialize({fieldName:_2,sortDir:_3})+")"}
...
,isc.A.getAvailableFieldWidth=function(){var _1=this.width-this.getHMarginBorder();var _2=this.$54u();if(_2){_1-=this.getScrollbarSize()}
return _1}
...
var _3=this.frozenFields;if(_3){var _4=this.getFrozenSlots(_1);_1=this.getUnfrozenSlots(_1);this.frozenBody.setColumnWidths(_4);var _5=_4.sum();this.frozenBody.setWidth(_5);this.frozenBody.$pn=_5;this.frozenHeader.setWidth(_5)}
...
this.bodyHeight=Math.max(1,(this.getInnerHeight()-_7));this.bodyWidth=Math.max(1,this.getInnerWidth());var _14=this.bodyLayout||this.body;_14.setRect(0,_7,this.bodyWidth,this.bodyHeight)}
...
,isc.A.draw=function(_1,_2,_3,_4){if(isc.$cv)arguments.$cw=this;if(!this.readyToDraw())return this;this.prepareForDraw();this.invokeSuper(isc.ListGrid,"draw",_1,_2,_3,_4);this.body.getColumnSizes();if(this.header&&this.sortFieldNum!=null)this.header.selectButton(this.sortFieldNum);this.bodyScrolled()}
...
,isc.A.getBaseStyle=function(_1,_2,_3){if(this.canEdit==true){if(this.editFailedBaseStyle&&this.cellHasErrors(_2,_3))
...
return _1[this.recordBaseStyleProperty];var _4=this.getField(_3);if(_4&&_4.baseStyle)return _4.baseStyle;if(_4&&_4.frozen&&this.frozenBaseStyle)return this.frozenBaseStyle;return this.baseStyle}
...
_1=this.$300(_2,_3)}
var _5=this.fields[_3],_6=null;if(_5==null)return"";var _7,_8=this.showValueIconOnly(_5),_9;if(_1!=null){if(_1[this.isSeparatorProperty])
...
return"&nbsp;"}
_9=(this.$30a&&this.$285==_2&&(!this.editByCell||this.$30u==_3)&&this.canEditCell(_2,_3));if(_9){_6=this.getEditItemCellValue(_1,_2,_3)}else{var _5=this.fields[_3],_10,_11;if(_5.displayField!=null){_11=!_5.valueMap&&!_5.getCellValue&&this.$425(_5);if(_11){var _12=_5.displayField;_10=this.getRawCellValue(_1,_2,_12,true)}}
...
_7=this.getValueIcon(_5,_6,_1);if(!_8){var _13=_5.valueMap;if(_13){if(isc.isA.String(_13))_13=this.getGlobalReference(_13);if(!isc.isAn.Array(_13))_6=isc.getValueForKey(_6,_13)}}
if(_11)_6=_10}}
if(!_9){var _14=null;if(_7!=null){var _15=_5.imageURLPrefix||_5.baseURL||_5.imgDir,_16=_5.imageURLSuffix,_17=this.getValueIconWidth(_5),_18=this.getValueIconHeight(_5),_19=this.getValueIconLeftPadding(_5),_20=this.getValueIconRightPadding(_5);if(_16!=null)_7+=_16;_14=isc.Canvas.$xq(_7,_15,_17,_18,_19,_20,null,this)}
if(_8){if(!_14||isc.isAn.emptyString(_14))_14=this.emptyCellValue;return _14}
_6=this.$315(_6,_1,_5,_2,_3);if(_14){if(_5.valueIconOrientation!=isc.Canvas.RIGHT)
_6=_14+_6;else
_6=_6+_14}
if(this.canEdit&&this.showErrorIcons&&this.cellHasErrors(_2,_3)){_6=this.getErrorIconHTML(_2,_3)+_6}}
return _6}
,isc.A.getCellAlign=function(_1,_2,_3){if(_1&&(_1[this.singleCellValueProperty]!=null)){return isc.Canvas.LEFT}
var _4=this.fields[_3];return(_4.cellAlign||_4.align)}
...
,isc.A.getErrorIconHTML=function(_1,_2){var _3=this.getCellErrors(_1,_2);if(_3==null)return isc.$ad;var _4="title='",_5=isc.FormItem.getErrorPromptString(_3);_4+=_5+"'";var _6=this.imgHTML(this.errorIconSrc,this.errorIconWidth,this.errorIconHeight,null,_4);if(isc.Browser.isIE&&this.$30a&&this.getEditRow()==_1&&(!this.editByCell||this.getEditCol()==_2)){_6+=" "}else{_6+=isc.Canvas.spacerHTML(this.cellPadding,"auto")}
return _6}
,isc.A.$315=function(_1,_2,_3,_4,_5){if(_3.formatCellValue!=null){_1=_3.formatCellValue(_1,_2,_4,_5,this)}else if(_3.cellValueTemplate){_1=_3.cellValueTemplate.evalDynamicString(this,{value:_1,record:_2,field:_3})}else if(this.formatCellValue!=null){_1=this.formatCellValue(_1,_2,_4,_5)}else if(_3.$63!=null){_1=_3.$62.shortDisplayFormatter(_1,_3,this,_2,_4,_5)}else if(_3.$31r!=null){_1=_3.$31r(_1,_3,this,_2,_4,_5)}
...
,isc.A.getCellBooleanProperty=function(_1,_2,_3,_4){var _5=false,_6=this[_1];if(_6==false)return false;var _7=this.fields[_3][_1];if(_7==false)return false;if(_4!=null){var _8=this.getRecord(_2,_3),_9=(_8!=null?_8[_4]:false);if(_9==false)return false;if(_9==true)return true}
return(_6==true)||(_7==true)}
,isc.A.getDrawArea=function(){if(this.body)return this.body.getDrawArea();return null}
,isc.A.bodyDrawing=function(_1){if(isc.$cv)arguments.$cw=this;if(this.$31v){isc.RPCManager.startQueue();for(var _2 in this.$45o){var _3=this.$45o[_2].fields,_4=this.$45o[_2].outputs,_5=isc.DataSource.getDataSource(_2);_5.fetchData({},{target:this,methodName:"$317"},{clientContext:{fields:_3},parameters:{outputs:_4.getUniqueItems()}})}}
this.requestVisibleRows();if(this.$31v){isc.RPCManager.sendQueue();this.$31v=null}}
);isc.evalBoundary;isc.B.push(isc.A.$45n=function(){this.$31v=null;this.$45o={};var _1=this.getDataSource();for(var i=0;i<this.completeFields.length;i++){var _3=this.completeFields[i];if(_3.optionDataSource==null||_3.autoFetchDisplayMap==false||(this.autoFetchDisplayMap==false&&_3.autoFetchDisplayMap==null))
{continue}
...
return true}
,isc.A.requestVisibleRows=function(){if(isc.ResultSet&&isc.isA.ResultSet(this.data)){if(this.body==null)return this.data.getRange(0);if(!this.data.lengthIsKnown()){this.body.showAllRows=false}else{this.body.showAllRows=(this.body.overflow==isc.Canvas.VISIBLE?true:this.showAllRecords)}
...
return null}
,isc.A.getPrintHTML=function(_1,_2,_3,_4){if(isc.ResultSet&&isc.isA.WindowedResultSet(this.data)){var _5=this.body.getVisibleRows(),_6=parseInt(_5[0]+(_5[1]-_5[0])/2);if(_1==null)_1=this.data.findFirstCachedRow(_6);if(_2==null)_2=this.data.findLastCachedRow(_6);this.logDebug("Midpoint: "+_6+", startRecord: "+_1+", endRecord: "+_2)}else{if(_1==null)_1=0;if(_2==null)_2=(this.data?this.data.getLength():0)}
...
_8.append("</TR>")}}
_8.append("</TABLE>");return _8.toString()}
...
if(_1!=null&&_1.$52e){this.toggleFolder(_1);return}
var _9=this.isEditable()&&(this.editEvent==isc.EH.CLICK||this.editOnFocus);if(_5.canToggle&&this.canEditCell(_2,_3)&&this.shouldToggle(_5)){var _10=this.getEditorValueMap(_5,this.getEditedRecord(_2,_3));if(_10==null&&isc.SimpleType.getBaseType(_5.type)==this.$g2){_10=[true,false]}
if(_10!=null){if(!isc.isAn.Array(_10))_10=isc.getKeys(_10);if(_10.length>1){var _11=this.getFieldName(_3),_12=this.getEditedCell(_2,_3),_13=_10.indexOf(_12);_13+=1;if(_13>=_10.length)_13=0;_12=_10[_13];if(!_9&&this.autoSaveEdits){this.setEditValue(_2,_3,_12,true,false);this.saveEdits(null,null,_2,_3)}else{this.setEditValue(_2,_3,_12)}}}}
...
if(_1!=null&&_1.$288!=null)_4.add({title:this.dismissEmbeddedComponentContextMenuItemTitle,record:_1,click:"target.closeRecord(item.record)"});_4.add({title:this.deleteRecordContextMenuItemTitle,click:"target.removeSelectedData()"});return(_4.length>0?_4:null)}
return null}
...
,isc.A.selectRecord=function(_1,_2){this.selectRecords(_1,_2)}
,isc.A.deselectRecord=function(_1){this.selectRecord(_1,false)}
,isc.A.selectRecords=function(_1,_2){if(_2==null)_2=true;if(!isc.isAn.Array(_1))_1=[_1];for(var i=0;i<_1.length;i++){if(_1[i]==null)continue;if(isc.isA.Number(_1[i]))_1[i]=this.getRecord(_1[i])}
this.selection.selectList(_1,_2)}
,isc.A.deselectRecords=function(_1){this.selectRecords(_1,false)}
...
if(_9)this.redraw("scrollIntoView")}
...
this.syncHeaderScrolling(_1,_2);this.syncFilterEditorScrolling(_1,_2)}
...
,isc.A.canEditCell=function(_1,_2){if(_2<0||_2>=this.fields.length)return false;var _3=this.getCellRecord(_1,_2);if(_3!=null){if(!this.recordIsEnabled(_1,_2))return false;if(_3.$288!=null)return false}
...
return true}
,isc.A.isEditable=function(){if(this.canEdit==false)return false;if(this.canEdit==true){var _1=this.getFields();for(var i=0;i<_1.length;i++){if(_1[i].canEdit!=false)return true}
...
,isc.A.startEditing=function(_1,_2,_3,_4){if(!this.canEdit)this.canEdit=true;if(this.completeFields==null)this.setFields(this.fields);var _5=(_1==null),_6=(_2==null);if(_5||_6){var _7=(_5?0:_1),_8=(_6?0:_2);var _9=this.findNextEditCell(_7,_8,1,_6,true);if(_9==null){this.logInfo("startEditing() passed bad cell coordinates:"+[_1,_2])}else{this.logInfo("startEditing() using derived coordinates:"+_9);_1=_9[0];_2=_9[1]}}
...
,isc.A.editCell=function(_1,_2){return this.startEditing(_1,_2)}
...
,isc.A.$32s=function(_1,_2){var _3=this.$30a;this.$30a=true;if(!this.isDrawn()||!this.body)return;var _4=this.isEmpty()||(!_3&&(_1>=this.data.getLength())&&(this.showNewRecordRow||(this.body.getTableElement(_1,_2)==null)));if(_4||this.body.isDirty()||(this.frozenBody&&this.frozenBody.isDirty())){var _5=this.bodyLayout?this.bodyLayout:this.body;_5.redraw("Showing editor");return}
if(this.editByCell){this.refreshCell(_1,_2)}else{var _6=this.getDrawnFields();for(var i=0;i<_6.length;i++){var _8=_6[i][this.fieldIdProperty],_9=this.$286.getItem(_8),_2=_9.colNum,_10=!!(_3&&_9.isDrawn()),_11=this.canEditCell(_1,i);if(_10!=_11)this.refreshCell(_1,_2);else if(this.selectOnEdit||this.lastOverRow){this.body.$29h(this.getCellRecord(_1,_2),_1,_2)}}}}
...
,isc.A.hideInlineEditor=function(_1,_2){_1=_1&&(this.hasFocus||this.body.hasFocus||(this.getEditForm()&&this.getEditForm().hasFocus)||(isc.ListGrid.$32u&&isc.ListGrid.$32u.hasFocus));if(!this.$30a)return false;this.$30a=null;var _3=this.$285,_4=this.$30u;this.$285=this.$30u=null;if(!_2)this.$286.hideClickMask();if(this.getEditValues(_3,_4)!=null&&(!this.$31o||!this.$31o[this.getEditValuesID(_3,_4)])&&!this.recordHasChanges(_3,_4,false))
...
,isc.A.makeEditForm=function(_1,_2){var _3=this.getCellRecord(_1,_2),_4=this.getEditRowItems(_3,_1,_2,this.editByCell),_5=this.getEditDisplayValues(_1,_2);if(this.$286!=null){this.$286.setItems(_4);this.$286.setValues(_5)}else{this.$286=isc.DynamicForm.create(this.editFormDefaults,{grid:this,showErrorIcons:this.showErrorIcons,tabIndex:this.getTabIndex(),dataSource:this.dataSource,autoComplete:this.autoComplete,uniqueMatch:this.uniqueMatch,autoFocus:false,items:_4,values:_5})}
this.logDebug("editRowForm created with values: "+this.echo(this.$286.getValues()),"gridEdit")}
...
var _5,_6;if((_2.$254==null)||_2.isDirty()){var _7=_2.getDrawArea();_5=_7[2];_6=_7[3]}else{_5=_2.$254;_6=_2.$255}
...
,isc.A.$325=function(_1,_2,_3,_4){this.invokeSuper(this.getClassName(),"handleChanged",_1,_2,_3,_4);this.grid.handleEditorChanged(this)}
...
_7.valueIcons=this.getEditorValueIcons(_1,_3);var _9=this.getEditorValueIconWidth(_1),_10=this.getEditorValueIconHeight(_1);if(_9)_7.valueIconWidth=_9;if(_10)_7.valueIconHeight=_10;_7.imageURLPrefix=(_1.editorImageURLPrefix||_1.imageURLPrefix);_7.imageURLSuffix=(_1.editorimageURLSuffix||_1.imageURLSuffix);_7.baseURL=_1.baseURL;_7.imgDir=_1.imgDir;var _11;if(_1.icons!==_11)_7.icons=_1.icons;if(_1.showPickerIcon!==_11)_7.showPickerIcon=_1.showPickerIcon;if(_1.pickerIconSrc!==_11)_7.pickerIconSrc=_1.pickerIconSrc;if(_1.pickerIconWidth!==_11)_7.pickerIconWidth=_1.pickerIconWidth;if(_1.pickerIconHeight!==_11)_7.pickerIconHeight=_1.pickerIconHeight;if(_1.defaultIconSrc!==_11)_7.defaultIconSrc=_1.defaultIconSrc;if(_1.iconHeight!==_11)_7.iconHeight=(_1.editorIconHeight||_1.iconHeight);if(_1.iconWidth!==_11)_7.iconWidth=(_1.editorIconWidth||_1.iconWidth);if(_1.iconPrompt!==_11)_7.iconPrompt=_1.iconPrompt;if(_1.iconHSpace!==_11)_7.iconHSpace=_1.iconHSpace;if(_1.iconVAlign!==_11)_7.iconVAlign=_1.iconVAlign;if(this.showValueIconOnly(_1)){if(_1.editorProperties==null)_1.editorProperties={};_1.editorProperties.showValueIconOnly=true}
if(_1.pickListWidth!=null)_7.pickListWidth=_1.pickListWidth;if(_1.pickListFields!=null)_7.pickListFields=_1.pickListFields;_7.keyDown=function(_7,_23,_24){return this.form.grid.editorKeyDown(_7,_24)}
if(_1.editorProperties!=null){for(var i=0;i<this.$31c.length;i++){var _13=this.$31c[i],_14=_1.editorProperties[_13];if(_14!=null&&!isc.isA.Function(_14)){var _15=isc.FormItem._stringMethodRegistry;_1.editorProperties[_13]=_14=isc.Func.expressionToFunction(_15[_13],_14)}
if(_14!=null)_1.editorProperties[_13]=_14}}
for(var i=0;i<this.$45k.length;i++){var _13=this.$45k[i];if(_1.editorProperties&&_1.editorProperties[_13]!=null)continue;var _14=_1[_13];if(_14!=null){if(_1.editorProperties==null)_1.editorProperties={};if(!isc.isA.Function(_14)){var _15=isc.FormItem._stringMethodRegistry;_14=isc.Func.expressionToFunction(_15[_13],_14)}
_1.editorProperties[_13]=_14}}
_7.valueIconLeftPadding=this.getValueIconLeftPadding(_1);_7.valueIconRightPadding=this.getValueIconRightPadding(_1);_7.editorType=this.getEditorType(_1,_2);var _16=_7.editorType;if(this.$308[_16]||(_1.type==this.$g4&&_16==null)){_7.editorType=this.$g4;_7.useTextField=true;_7.cellPadding=0;_7.itemCellStyle=null;_7.pickerIconHSpace=0;var _17=this.$45i(_1);if(_17)_7.displayFormat=_17;var _18=this.$45j(_1);if(_18)_7.inputFormat=_18}
if(this.$307[_16]||(_1.type==this.$g5&&_16==null)){var _17=this.$30o(_1);if(_17)_7.displayFormat=_17}
if(this.$309[_16]){var _19=this.showRollOver;this.showRollOver=false;_7.getTextBoxStyle=function(){var _20=this.grid,_2=_20.getCellRecord(this.rowNum,this.colNum);this.textBoxStyle=_20.getCellStyle(_2,this.rowNum,this.colNum);return this.Super("getTextBoxStyle",arguments)}
_7.gridCellStyleChanged=function(_2,_4,_5,_23){var _21=this.$15h();if(_21){_21.className=this.textBoxStyle=_23}}
_7.textBoxCellCSS=isc.Canvas.$42a
this.showRollOver=_19;_7.textAreaKeyDown=this.$54z;_7.textAreaKeyPress=this.$323;_7.getTextAreaTop=this.$324;if(_7.popUpOnEnter==null)_7.popUpOnEnter=true}
if(this.$31a[_16]||(_1.type==this.$g2&&_16==null)){if(_7.showLabel==null)_7.showLabel=false}
_7.elementFocus=this.$30t;_7.canTabToIcons=false;_7.focusInItem=this.$51o;var _22=this.getEditorProperties(_1,_2);isc.addProperties(_7,_22);return _7}
...
,isc.A.refreshCell=function(_1,_2,_3,_4){if(!this.isDrawn()||!this.body)return;var _5=this.getFieldBody(_2);if(_5.isDirty()){this.logDebug("refresh cell redrawing body","gridEdit");_5.redraw("refresh cell");return false}
...
,isc.A.startEditingNew=function(_1,_2){if(!this.canEdit)this.canEdit=true;if(isc.isAn.Array(this.data)&&this.data.length==0&&this.dataSource&&!this.saveLocally)
...
,isc.A.$50r=function(_1,_2,_3,_4){if(!_3)return;var _5=this.isEditingRecord(_1,_2)&&this.$286!=null
...
if(!_7){if(_2>=0)this.refreshCell(_1,_2)}else if(_4&&_4[_6]){this.showCellErrors(_1,_2)}}}
...
if(_5==null){_6.$33i=true;var _10=this.completeFields||this.fields||[],_11;for(var i=0;i<_10.length;i++){var _12=_10[i],_13=_12[this.fieldIdProperty];if(_12.defaultValue!=null&&_3[_13]===_11){_3[_13]=_12.defaultValue}}}
...
var _14=this.getField(_6);if(_14&&this.$425(_14)){this.clearEditValue(_1,_14.displayField,_3,_4)}
...
,isc.A.$52p=function(_1,_2){var _3,_4,_5=_1.$33b;if(_5==null){_3=_2}else{var _6=_1.$31x,_7=false,_8;for(var _9 in _6){if(_6[_9]!=_5[_9]||_5[_9]===_8){_7=true}}
...
{return}
var _10,_11=[],_12=this.$285,_13=this.getEditValues(_12,_7),_14=this.body.getDrawArea(),_15=_14[2],_16=_14[3],_17;if(_13!=null){if(this.isNewEditRecord(_12,_7)){_10=true}else{for(var i=_15;i<=_16;i++){if(_13[this.getFieldName(i)]!==_17&&((this.editByCell&&this.$30u!=i)||!this.canEditCell(_12,i)))
{_11.add(i)}}}
this.$321(this.$285,_7,true)}
this.hideInlineEditor(true);if(_10)this.body.markForRedraw("clearing extra edit row");else{for(var i=0;i<_11.length;i++){this.refreshCell(_12,_11[i])}}}
...
,isc.A.findNextEditCell=function(_1,_2,_3,_4,_5,_6,_7){var _8=_1,_9=_2,_10,_11=this.getFields().length;_10=(_7?_8:(this.listEndEditAction=="next"||_6)?this.getTotalRows():this.getTotalRows()-1);if(_8>this.getTotalRows())_10=_8;if((_5!=false||_3==0)&&_8<=_10&&_8>=0&&_9<_11&&_9>=0&&this.canEditCell(_8,_9))
{return[_8,_9]}
if(_3==0)return null;var _12=this.canEditCell(_8,_9),_13=_7?_8:0;if(_4){var _14=this.rowEndEditAction;while(_8<(_10+1)&&_8>=_13){_9+=_3;if(_14=="same"&&_2==_9){return _12?[_1,_2]:null}
if(_9<0||_9>=_11){if(_14=="done")return null;if(_14=="stop")return(_12?[_1,_2]:null)
else{_9=(_3>0?-1:_11);if(_14=="next")_8+=_3}}else if(this.canEditCell(_8,_9)){return[_8,_9]}}
...
while(_8>=_13&&_8<=_10){if(this.canEditCell(_8,_9)){return[_8,_9]}
_8+=_3}
if(this.listEndEditAction=="stop"||(this.listEndEditAction=="next"&&_8<_13))
...
if(_3==null)return false;var _6=this.getEditValues(_3,_4),_7=this.getCellRecord(_3,_4),_8=this.getEditValuesID(_3,_4);var _9;if(_7!=null&&_7!=Array.LOADING){if(isc.isA.Tree(this.data)){_9=this.data.getCleanNodeData(_7,false)}else{_9=isc.addProperties({},_7)}
...
return _1}
,isc.A.saveEditedValues=function(_1,_2,_3,_4,_5,_6,_7){var _8={editValuesID:_5,rowNum:_1,colNum:_2,values:_3,oldValues:_4,editCompletionEvent:_6};if(!this.dataSource||this.saveLocally)return this.$336(_8,_7);var _9=this.getID()+".$337(dsResponse, dsRequest)",_10={operation:(this.oldValues==null?this.addOperation:this.updateOperation)||this.saveOperation,application:this.application,willHandleError:true,showPrompt:this.shouldWaitForSave(),oldValues:_4,$52s:this.getRecord(_1,_2),clientContext:{saveCallback:_7,newValues:_3,editInfo:_8}};this.$338(_3,_4);if(this.$31o==null)this.$31o={};this.$31o[_8.editValuesID]=true;var _11=isc.DS.get(this.dataSource);if(_4==null){var _12=isc.addProperties({},_4,_3);_11.addData(_12,_9,_10)}else{var _13=isc.DS.get(this.dataSource).filterPrimaryKeyFields(_4),_14=isc.addProperties({},_13,_3);_11.updateData(_14,_9,_10)}}
);isc.evalBoundary;isc.B.push(isc.A.$336=function(_1,_2){var _3=_1.rowNum,_4=_1.colNum,_5=_1.oldValues,_6=_1.values;var _7=this.getCellRecord(_3,_4),_8=(_7==null);if(_8){var _9=this.getData();var _10=this.getEditSession(_3);_10.$33b=this.getPrimaryKeys(_6);delete _10.$33i;_9.add(_6);_9.dataChanged()}else{var _11,_12;for(var i=0;i<this.fields.length;i++){_11=_6[this.fields[i][this.fieldIdProperty]];if(_11!==_12)this.setRawCellValue(_7,_3,i,_11)}}
this.$338(_6,_5);this.$339(_1,_2)}
,isc.A.$338=function(_1,_2){if(this.sortFieldNum==null)return;var _3=this.fields[this.sortFieldNum];if(_3==null)return;var _4=_3[this.fieldIdProperty];var _5;if(_4!=null&&_1[_4]!==_5&&(_2==null||_1[_4]!=_2[_4]))
{this.unsort()}}
...
return _1}
,isc.A.$339=function(_1,_2,_3,_4){if(this.$30a&&this.getEditForm().hasFocus)this.storeUpdatedEditorValue(true);var _5=_1.rowNum,_6=_1.colNum,_7=_1.editValuesID,_8=this.getEditSession(_7);var _9;if(_3!=null){_9=isc.isAn.Array(_3.data)?_3.data[0]:_3.data;if(_9==null){return}
if(_8&&_8.$33b==null){this.newRecordForEditValues(_7,_9)}}else{_9=this.getCellRecord(_5,_6)}
var _10=_1.values,_11=this.$300(_7),_12=this.isEditingRecord(_5,_6),_13=this.dataSource?isc.DS.get(this.dataSource).getPrimaryKeyFieldNames():null;var _14=false;for(var _15 in _11){var _16=_13&&_13.contains(_15);if(this.fieldValuesAreEqual(this.getField(_15),_11[_15],_10[_15]))
{if(!(_12&&_16))this.clearEditValue(_7,_15,true,true)}else{if(!_16)_14=true}}
if(!_12&&!_14){this.$321(_7,_6)}
if(_3!=null||_1.newRecord){this.displayUpdatedDSRecord(_5,_6,_9)}
var _17=_1.values,_18=_1.oldValues,_19=_1.editCompletionEvent;if(_5==-1)_5=_1.rowNum;if(this.convertToMethod("editComplete")){this.editComplete(_5,_6,_17,_18,_19,_3)}
this.$50u(_9,_5,_6,_17,_18,_4);if(_2)this.$332(_2,_5,_6,_19,true)}
...
,isc.A.$50u=function(_1,_2,_3,_4,_5,_6){var _7;for(var i in _4){var _9=(_5==null?null:_5[i]);if(_4[i]==_9)continue;var _10=this.fields.find(this.fieldIdProperty,i);if(this.isGrouped&&this.groupByField.contains(_10.name)){_7=true}
this.$34a(_1,_10,_4[i],_9,_2,this.fields.indexOf(_10))}
if(_7){this.$34v=true;var _11=_1;if(this.dataSource&&!this.saveLocally){var _12=this.groupTree.idField;_11=_6.$52s}
var _13=this.data.getParents(_11);this.data.remove(_11);for(var i=0,j=this.groupByField.length-1;i<_13.length-1;i++){var _15=_13[i];if(_15.groupMembers.getLength()==0){this.data.remove(_15)}else{var _16=this.fields.find("name",this.groupByField[j]);if(_16.getGroupTitle){_15.singleCellValue=_16.getGroupTitle(_15.groupValue,_15,_16,_16.name,this)}}
j--}
...
,isc.A.startRowAnimation=function(_1,_2,_3,_4,_5,_6,_7,_8,_9){if(!this.body)return;this.body.startRowAnimation(_1,_2,_3,_4,_5,_6,_7,_8,true,_9)}
...
else _2=Math.min(_2,this.data.getLength());var _3=_1.transferDragData();var _4=this.data.get(_2);this.transferRecords(_3,_4,_2,_1)}
...
var _4=(this.canReorderRecords&&_1==this?this.selection.getSelection():_1.transferDragData?_1.transferDragData():null);var _5=this.data.get(_2);return this.recordDrop(_4,_5,_2,_1)}
...
,isc.A.transferRecords=function(_1,_2,_3,_4){if(_4==this){if(_3!=null&&!this.isGrouped)this.data.slideList(_1,_3)}else{if(!isc.isAn.Array(_1))_1=[_1];if(this.selectionType==isc.Selection.MULTIPLE||this.selectionType==isc.Selection.SIMPLE)
...
if(!_5)isc.rpc.sendQueue()}else{if(this.isGrouped){for(var i=0;i<_1.length;i++){this.$52u(_1[i],true)}
if(_3!=null)this.originalData.addListAt(_1,_3);else this.originalData.addList(_1)}else{if(_3!=null)this.data.addListAt(_1,_3);else this.data.addList(_1)}}}
...
,isc.A.deriveFrozenFields=function(){var _1=this.frozenFields=this.fields.findAll("frozen",true);if(_1&&_1.length==this.fields.length){_1=this.frozenFields=null;this.$54d=true}else this.$54d=false;if(_1){this.fields.slideList(_1,this.freezeLeft()?0:this.fields.length);this.completeFields.slideList(_1,this.freezeLeft()?0:this.completeFields.length);this.resizeFieldsInRealTime=false}
for(var i=0;i<this.fields.length;i++){var _3=this.fields[i];_3.masterIndex=i}
if(_1){var _4=this.normalFields=[];for(var i=0;i<this.fields.length;i++){var _3=this.fields[i];if(!_3.frozen)_4.add(_3)}}else this.normalFields=null}
,isc.A.rebuildForFreeze=function(_1){if(!this.body)return;this.endEditing();this.deriveVisibleFields();this.updateHeader();this.updateBody(_1);this.layoutChildren();this.syncHeaderScrolling(this.body.getScrollLeft())}
...
,isc.A.toggleFrozen=function(_1,_2){var _1=this.getField(_1);if(!_1||!this.fieldIsVisible(_1))return;if(_1.frozen==_2)return false;_1.frozen=_2;this.rebuildForFreeze();return true}
...
,isc.A.createBody=function(_1,_2,_3){var _4=isc.ClassFactory.getClass(this.bodyConstructor).createRaw();_4.ID=_1;_4.autoDraw=false;_4.grid=this;_4.fields=_2;_4.overflow=_3?"hidden":this.bodyOverflow;if(_3){_4.mouseWheel=function(){var _5=this.ns.EH.lastEvent.wheelDelta;var _6=this.scrollTop+(_5*50);this.scrollTo(this.getScrollLeft(),_6);return false}}
_4.backgroundColor=this.bodyBackgroundColor;_4.styleName=this.bodyStyleName;_4.allowContentAndChildren=true;_4.fixedRowHeights=this.fixedRecordHeights;_4.fixedColumnWidths=this.fixedFieldWidths;_4.alternateRowStyles=this.alternateRecordStyles;_4.alternateRowFrequency=this.alternateRecordFrequency;_4.showAllRows=this.showAllRecords;_4.virtualScrolling=this.virtualScrolling;_4.tabIndex=this.getTabIndex();_4.dragTarget=this.canDragSelect?null:this;_4.dragAppearance=isc.EventHandler.NONE;var _7=isc.ListGrid.$295;for(var i=0;i<_7.length;i++){var _9=_7[i],_10=this[_9];if(_10!=null)_4[_9]=_10}
isc.addProperties(_4,this.bodyDefaults,this.bodyProperties);this.$51e(_4);_4.completeCreation();return _4}
,isc.A.getRowHeight=function(_1,_2){var _3=this.cellHeight;if(this.frozenFields&&this.getEditRow()==_2){var _4=this.getEditForm(),_5=_4.getItems();for(var i=0;i<_5.length;i++){var _7=(_5[i].getHeight()+2*this.cellPadding);if(_7>_3)_3=_7}}
...
return this.invokeSuper(null,"getActionType",_9,_10,_11,_12)},getTitle:this.buttonTitleFunction,mouseOver:function(){var _4=this.parentElement.grid;if(_4.shouldShowHeaderMenuButton(this)){var _7=_4.getHeaderMenuButton();this.addPeer(_7);if(this.zIndex>_7.zIndex)_7.bringToFront();if(!_7.isVisible()){_7.show()}}},mouseOut:function(){var _4=this.parentElement.grid,_8=_4.headerMenuButton;if(_8&&_8.isVisible()&&_8.masterElement==this&&isc.EH.getTarget()!=_8)
{_4.headerMenuButton.hide()}}},_1);return _2}
,isc.A.makeHeader=function(_1){if(this.header!=null)return;var _2=this.header=this.makeHeaderForFields(this.normalFields||this.fields);if(this.sorter==null)this.makeCornerSortButton();this.headers=[_2];if(!this.frozenFields){this.addChild(_2,null,!_1);return}
var _3=this.frozenHeader=this.makeHeaderForFields(this.frozenFields,"visible",this.getID()+"$51f");if(this.freezeLeft()){this.headers.unshift(this.frozenHeader)}else{this.headers.add(this.frozenHeader)}
...
,isc.A.createHeader=function(_1){var _2=isc.addProperties({makeButton:function(_3){if(_3.headerTitleStyle)_3.titleStyle=_3.headerTitleStyle;else if(_3.frozen&&this.buttonProperties.frozenTitleStyle)
_3.titleStyle=_3.frozenTitleStyle;if(_3.frozen&&this.buttonProperties.frozenSrc)
_3.src=this.buttonProperties.frozenSrc;var _3=this.Super("makeButton",arguments);var _4;if(_3.headerBaseStyle){_3.baseStyle=_3.headerBaseStyle;_4=true}else if(!_4){if(_3.frozen&&this.buttonProperties.frozenBaseStyle)
_3.setBaseStyle(this.buttonProperties.frozenBaseStyle);else if(this.buttonProperties.baseStyle!=null)
_3.setBaseStyle(this.buttonProperties.baseStyle)}
return _3},buttonProperties:this.getHeaderButtonProperties(),border:this.headerBorder,styleName:this.headerBarStyle,backgroundColor:this.headerBackgroundColor,backgroundImage:this.headerBackgroundImage,tabIndex:(this.canTabToHeader?this.getTabIndex():-1),canResizeItems:this.canResizeFields,canReorderItems:this.canReorderFields,dontObserve:false},_1);if(this.headerButtonConstructor!=null)
_2.buttonConstructor=this.headerButtonConstructor;var _5=this.createAutoChild("header",_2,isc.Toolbar);if(_5.canReorderItems&&!_5.dontObserve){this.observe(_5,"itemDragReordered","observer.headerDragReordered(itemNum,newPosition,this)")}
if(_5.canResizeItems&&!_5.dontObserve){this.observe(_5,"itemDragResized","observer.headerDragResized(itemNum,newSize,this)");this.observe(_5,"dragResizeMemberStart","observer.fieldDragResizeStart()");this.observe(_5,"dragResizeMemberMove","observer.fieldDragResizeMove()");this.observe(_5,"dragResizeMemberStop","observer.fieldDragResizeStop()")}
return _5}
...
,isc.A.setHeaderHeight=function(_1){var _2=this.headerHeight;if(_2==_1)return;this.headerHeight=_1;if(this.showHeader==false)return;if(!this.header&&_1>0){if(this.isDrawn())this.makeHeader()}else{if(_2==0)this.updateHeader();this.layoutChildren("header height changed")}}
,isc.A.setShowHeader=function(_1){if(_1==this.showHeader)return;this.showHeader=_1;this.updateHeader();this.layoutChildren("header visibility changed")}
,isc.A.shouldShowHeaderMenuButton=function(_1){if(this.showHeaderContextMenu&&this.showHeaderMenuButton){var _2=this.getHeaderContextMenuItems(_1.masterIndex);return(_2.length>0)}
return false}
...
,isc.A.headerMenuButtonClick=function(){var _1=this.header.getMember(this.header.getMouseOverButtonIndex()),_2=_1.getPageBottom(),_3=this.$314?this.$314.getVisibleWidth():isc.Menu.getPrototype().defaultWidth,_4=Math.max(_1.getPageLeft(),(_1.getPageRight()-_3));return this.displayHeaderContextMenu(_1,[_4,_2])}
,isc.A.getHeaderButtonTitle=function(_1){var _2=_1;if(isc.isA.Object(_1))_2=_1.masterIndex;var _3=this.fields[_2];if(!_3)return"";var _4=(_2==this.sortFieldNum)&&(!this.showSortArrow||this.showSortArrow==isc.ListGrid.FIELD||this.showSortArrow==isc.ListGrid.BOTH),_5=this.getFieldTitle(_2);return _5+(_4?"&nbsp;"+this.getSortArrowImage():"")}
,isc.A.headerClick=function(_1,_2){var _3=_2.getMember(_1).masterIndex,_4=this.fields[_3];if(this.canSort==false||!_4||_4.canSort==false)return false;if(_3==this.sortFieldNum){var _5=_4.sortDirection==null?this.sortDirection:_4.sortDirection;this.sort(_3,!Array.shouldSortAscending(_5))}else{this.sort(_3)}
return false}
);isc.evalBoundary;isc.B.push(isc.A.fieldDragResizeStart=function(){this.makeDragLine();this._dragLine.resizeTo(2,this.getVisibleHeight()-(this.body.hscrollOn?this.getScrollbarSize():0));this.ns.EH.dragTarget.setOverflow("hidden")}
...
,isc.A.reorderFields=function(_1,_2,_3){var _4=this.fields[_1],_5=this.fields[_2-1],_6=_1+_3,_7=this.fields[_6];var _8=this.fields[this.sortFieldNum];this.$26a.slideRange(_1,_2,_1+_3);if(this.completeFields.contains(_7)){var _9=this.completeFields.indexOf(_4),_10=this.completeFields.indexOf(_5)+1,_11=this.completeFields.indexOf(_7);this.completeFields.slideRange(_9,_10,_11)}
this.deriveVisibleFields()
if(this.sortFieldNum!=null){this.sortFieldNum=this.fields.indexOf(_8);if(this.sortFieldNum==-1)this.sortFieldNum=null}
var _12;if(!this.frozenFields){_12=this.getFieldHeader(_1);if(_12){_12.reorderItems(this.getLocalFieldNum(_1),this.getLocalFieldNum(_2),this.getLocalFieldNum(_1+_3))}}else{this.rebuildForFreeze();_12=this.getFieldHeader(_1)}
if(this.sortFieldNum!=null&&_12)
_12.selectButton(this.getLocalFieldNum(this.sortFieldNum));var _13=this.$30a;if(_13){var _14=this.$286,_15=this.getEditRow(),_16=this.getEditField(),_17=[]
for(var i=0;i<_14.items.length;i++){var _19=_14.items[i];_19.colNum=this.fields.findIndex(this.fieldIdProperty,_19.getFieldName());for(var j=0;j<=_17.length;j++){if(_17[j]==null||_17[j].colNum>_19.colNum){_17.addAt(_19,j);break}}}
_14.items.setArray(_17);this.$30u=this.fields.indexOf(_16)}
...
(this.showHeader?_2:0);if(_3<=0)return false;return this.predictScrollbarGap&&this.bodyOverflow==isc.Canvas.AUTO&&(this.getTotalRows()*this.cellHeight>_3)}
,isc.A.getSorterLeft=function(){if(this.isRTL()){return this.getLeftMargin()+this.getLeftBorderSize()}else{return this.width-this.getScrollbarSize()-this.getHMarginBorder()}}
...
,isc.A.displayHeaderContextMenu=function(_1,_2){var _3=this.getHeaderContextMenuItems(_1.masterIndex);if(_3.length==0)return;if(!this.$314)this.$314=this.getHeaderContextMenu(_1);this.$314.setData(_3);if(_2!=null&&_2.length>0){this.$314.moveTo(_2[0],_2[1]);this.$314.show();return false}else{return this.$314.showContextMenu(_1)}}
,isc.A.getToggleFreezeText=function(_1){return(_1.frozen?"Unfreeze ":"Freeze ")+this.getSummaryTitle(_1)}
,isc.A.getGroupByText=function(_1){return"Group by "+this.getSummaryTitle(_1)}
,isc.A.getHeaderContextMenuItems=function(_1){var _2=this.getField(_1);var _3=[],_4=[],_5=false;var _6=this.canSort&&((_2&&_2.canSort!=false)||(!_2&&this.sortFieldNum!=null));if(_6){var _7=_1!=null?_1:this.sortFieldNum;_3[0]={title:this.sortFieldAscendingText,icon:"[SKINIMG]actions/sort_ascending.png",click:"menu.doSort("+_7+", 'ascending')"};_3[1]={title:this.sortFieldDescendingText,icon:"[SKINIMG]actions/sort_descending.png",click:"menu.doSort("+_7+", 'descending')"};_5=true}
if(this.canPickFields&&this.completeFields.length>1){for(var i=0;i<this.completeFields.length;i++){var _9=this.completeFields[i];if(_9.treeField)continue;var _10=this.getSummaryTitle(_9);if(_10==null||isc.isAn.emptyString(_10))continue;_4[_4.length]={title:_10,fieldName:_9.name,checked:this.fieldIsVisible(_9),autoDismiss:false,enableIf:this.ID+".$314.shouldEnable(this, "+i+")",click:"menu.$35q.toggleField(item, menu)"}}
if(_4.length>1){if(_5)_3.add({isSeparator:true});_3.add({title:this.fieldVisibilitySubmenuTitle,submenu:_4,icon:"[SKINIMG]actions/column_preferences.png"});_5=true}}
var _11=_2&&((this.canGroupBy==true&&_2.canGroupBy!=false)||(this.canGroupBy!=false&&_2.canGroupBy==true)),_12=(this.canGroupBy!=false)&&this.isGrouped;if(_5&&(_12||_11)){_3.add({isSeparator:true})}
if(_11){_3.add({groupItem:true,title:this.getGroupByText(_2),enabled:(this.data.getLength()<=this.groupByMaxRecords),fieldName:_2.name,icon:"[SKINIMG]actions/groupby.png",click:"menu.groupField(item)"});_5=true}
if(_12){_3.add({title:this.ungroupText,click:"menu.ungroup()",icon:"[SKINIMG]actions/ungroup.png"});_5=true}
if(!_2)return _3;if(this.canFreezeFields&&this.fields.length>1&&(_2.frozen||(this.frozenFields==null||this.normalFields.length>1)))
{if(_5)_3.add({isSeparator:true});_3.add({title:this.getToggleFreezeText(_2),grid:this,field:_2,icon:(_2.frozen?"[SKINIMG]actions/unfreeze.png":"[SKINIMG]actions/freezeLeft.png"),click:"item.grid.toggleFrozen(this.field,!this.field.frozen)"})}
return _3}
...
if(_5)_2.setItemEnabled(_3,true)}},groupField:function(_7){var _1=this.grid;if((!_1.groupByField)||!_1.groupByField.contains(_7.fieldName)){_1.groupBy(_7.fieldName)}},ungroup:function(){this.grid.ungroup()},shouldEnable:function(_7,_8){for(var i=0;i<_7.data.length;i++){if(_7.data[i].checked&&i!=_8)return true}
if(_7.data[_8].checked)return false;else return true}})}
,isc.A.getSortArrowImage=function(){if(this.canSort&&this.sortFieldNum!=null){return this.imgHTML((Array.shouldSortAscending(this.getField(this.sortFieldNum).sortDirection)?this.sortAscendingImage:this.sortDescendingImage),null,null,null,null,this.widgetImgDir)}else{return isc.Canvas.spacerHTML(1,1)}}
,isc.A.sorterClick=function(){if(!this.canSort)return false;this.sort(this.sortFieldNum,(this.sortFieldNum!=null?!Array.shouldSortAscending(this.getField(this.sortFieldNum).sortDirection):null))}
...
,isc.A.unsort=function(){if(this.data.unsort&&this.data.unsort()){var _1=this.sortFieldNum;this.sortFieldNum=null;if(_1!=null&&this.header&&isc.isA.Toolbar(this.header)){this.header.deselectButton(_1);var _2=this.header.getButton(_1);if(_2)_2.setTitle(this.getHeaderButtonTitle(_2))}
if(this.sorter)this.sorter.setTitle(this.sorter.getTitle())}}
,isc.A.resort=function(){var _1=this.sortFieldNum;this.sortFieldNum=null;return this.sort(_1)}
,isc.A.sort=function(_1,_2){if(this.canSort==false)return false;if(this.confirmDiscardEdits&&this.dataSource!=null){if(this.hasChanges()&&isc.ResultSet&&isc.isA.ResultSet(this.data)&&!this.data.allMatchingRowsCached())
...
,isc.A.sortData=function(){if(!this.data||!this.fields)return;var _1=this.fields[this.sortFieldNum],_2=null;if(_1==null){this.sortFieldNum=0;_1=this.fields[0]}
...
,isc.A.regroup=function(_1){if(!this.isGrouped||(this.canGroupBy==false)||!this.groupByField||!this.groupByField.length||this.inhibitRegroup||!this.data||!this.data.getLength())
{return}
...
this.groupTree=null;this.groupTree=this.createAutoChild("groupTree",{dataSource:this.dataSource,defaultLoadState:isc.Tree.LOADED,loadDataOnDemand:false,parentIdField:"groupParentId",titleProperty:"groupValue",childrenProperty:"groupMembers",showRoot:false,isGroupedOutput:true},(this.dataSource?isc.ResultTree:isc.Tree));this.logInfo("Adding "+_2.getLength()+" records to groups","grouping");for(var i=0;i<_2.getLength();i++){this.$52u(_2.get(i),false)}
var _5=this.groupTree.getRoot(),_6=0,_7=0,_8=this.groupTree;while(_5!=null&&_7<this.groupByField.length){var _9=_8.getChildren(_5);for(var i=0;i<_9.length;i++){var _10=this.fields.find("name",this.groupByField[_7]);if(_10.getGroupTitle){var _11=_9[i];_11.singleCellValue=_10.getGroupTitle(_11.groupValue,_11,_10,_10.name,this)}}
...
if(this.groupStartOpen=="all"){_8.openAll()}else if(this.groupStartOpen=="first"){_8.openAll(_8.getChildren(_8.getRoot()).first())}
this.data=_8;if(!_1){this.$31m(this.data)}else{this.observe(_8,"changeDataVisibility","observer.$34u()")}
this.$31l()}
...
return}
if(this.groupByField)this.groupByField.setLength(0);else this.groupByField=[];for(var i=0;i<_2.length;i++){this.groupByField.add(_2[i])}
...
,isc.A.$52u=function(_1,_2){var _3,_4=this.groupTree.getRoot();for(var i=0;i<this.groupByField.length;i++){var _6=this.groupByField[i],_7=this.fields.findIndex("name",_6),_8=this.fields.get(_7);var _9=this.getRawCellValue(_1,i,_7);if(_8.getGroupValue){_9=_8.getGroupValue(_9,_1,_8,_6,this)}
...
_4=_3}
this.groupTree.add(_1,_4);if(_2){var _10=this.groupTree.getParents(_1);for(var i=_10.length-2,j=0;i>=0;i--,j++){var _12=this.fields.find("name",this.groupByField[j]);if(_12.getGroupTitle){var _13=_10[i];_13.singleCellValue=_12.getGroupTitle(_13.groupValue,_13,_12,_12.name,this)}}}}
...
,isc.A.click=function(_1,_2){var _3=this.grid,_4=_3.getEventRecordNum(),_5=_3.getRecord(_4);if(_3.data.isFolder(_5)&&_3.clickInOpenArea(_5)){_3.toggleFolder(_5);_3.clearLastHilite();_3.$31q=null;return isc.EH.STOP_BUBBLING}
...
,isc.A.transferNodes=function(_1,_2,_3,_4){var _5=_4.getData(),_6=(isc.isA.Tree(_5)&&isc.isA.Tree(this.data)&&_5.getRoot()==this.data.getRoot());var _7=this.getDataSource();if(_6&&(this.dragDataAction!=isc.TreeGrid.COPY&&this.dragDataAction!=isc.TreeGrid.CLONE))
{if(_7!=null&&this.data!=null&&isc.ResultTree&&isc.isA.ResultTree(this.data))
{var _8=isc.rpc.startQueue();for(var i=0;i<_1.length;i++){var _10=isc.addProperties({},this.data.getCleanNodeData(_1[i]));_10[this.data.parentIdField]=_2[this.data.idField];_7.updateData(_10)}
if(!_8)isc.rpc.sendQueue();return}else{_5.moveList(_1,_2,_3)}}else if(_7!=null){var _11=_4.getDataSource();if(this.dragRecategorize&&_11!=null&&this.data!=null&&isc.ResultTree&&isc.isA.ResultTree(this.data))
{var _12=_11.getTreeRelationship(_7);if(_12!=null&&_12.parentIdField){var _13=false,_14=_11.getPrimaryKeyFields();for(var _15 in _14){if(_15==_12.parentIdField){this.logWarn("dragRecategorize: data source has dataSource:"+_11.getID()+". foreignKey relationship with "+"target dataSource "+_7.getID()+" is based on primary key which cannot be modified.");_13=true}}
if(!_13){this.logInfo("Recategorizing dropped nodes in dataSource:"+_11.getID());var _8=isc.rpc.startQueue();for(var i=0;i<_1.length;i++){var _10=isc.addProperties({},_1[i]);_10[_12.parentIdField]=_2[_12.idField];_11.updateData(_10)}
if(!_8)isc.rpc.sendQueue();return}}}
_1=_4.transferDragData();var _8=isc.rpc.startQueue();for(var i=0;i<_1.length;i++){var _16=_1[i],_17=this.data;if(_17){_16[_17.parentIdField]=_2[_17.idField]}
_7.addData(_16)}
if(!_8)isc.rpc.sendQueue()}else{this.data.addList(_4.transferDragData(),_2,_3)}}
...
,isc.A.getIndentHTML=function(_1){if(!this.showRoot)_1--;return this.$348(_1*this.indentSize)}
...
return null}
,isc.A.$35e=function(_1){var _2=this.data.indexOf(_1),_3=this.getRecord(_2-1),_4=this.data.getParent(_1);if(_3==null)return false;return(_4==_3||_4==this.data.getParent(_3))}
,isc.A.$35d=function(_1){var _2=this.data.indexOf(_1),_3=this.getRecord(_2+1);if(_3==null)return false;return(this.data.getParent(_1)==this.data.getParent(_3))}
...
if(this.showConnectors&&!this.$35g){var _5=this.connectorImage,_6=["single","start","end","middle","opened_single","opened_end","closed_single","closed_start","closed_middle","closed_end"],_7={},_8=this.isRTL(),_9="$35h";for(var i=0;i<_6.length;i++){var _11=_6[i],_12=_11;if(_8)_12+=_9;_7[_11]=isc.Img.urlForState(_5,null,null,_12)}
this.$35g=_7}
...
);isc.B._maxIndex=isc.C+65;isc.TreeGrid.registerStringMethods({folderOpened:"node",folderClosed:"node",folderClick:"viewer,folder,recordNum",leafClick:"viewer,leaf,recordNum",nodeClick:"viewer,node,recordNum",folderContextClick:"viewer,folder,recordNum",leafContextClick:"viewer,leaf,recordNum",nodeContextClick:"viewer,node,recordNum"});isc.ClassFactory.defineClass("ButtonStrip","GridRenderer");isc.A=isc.ButtonStrip.getPrototype();isc.A.buttons=[];isc.A.buttonDefaults={};isc.A.buttonSpacing=3;isc.A.buttonPadding=2;isc.A.defaultButtonHeight=20;isc.A.defaultButtonWidth=100;isc.A.vertical=false;isc.A.overflow=isc.Canvas.VISIBLE;isc.A.showRollOver=true;isc.A.useCellRollOvers=true;isc.A.canDrag=false;isc.A.canDragSelect=false;isc.A.canSelectCells=false;isc.A.fastCellUpdates=true;isc.A.titleAlign="center";isc.A.fillSpace=false;isc.A.backgroundColor=null;isc.A.baseStyle="button";isc.A=isc.ButtonStrip.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.initWidget=function(){this.Super(this.$oc);if(this.buttonPadding!=null)this.cellPadding=this.buttonPadding;if(this.buttonSpacing!=null)this.cellSpacing=this.buttonSpacing;var _1=[];for(var i=0;i<this.buttons.length;i++){this.buttons[i]=isc.addProperties({},this.buttonDefaults,this.buttons[i]);if(this.vertical)_1[i]=this.buttons[i].height}
...
,isc.A.getButton=function(_1){return this.buttons[_1]}
,isc.A.getCellRecord=function(_1,_2){var _3=(this.vertical?_1:_2);return this.getButton(_3)}
,isc.A.getCellValue=function(_1,_2,_3){if(_1==null)_1=this.getCellRecord(_2,_3);return _1.getTitle?_1.getTitle():_1.title}
,isc.A.getTotalRows=function(){return(this.vertical?this.buttons.length:1)}
,isc.A.getRowHeight=function(_1,_2){if(!this.vertical)return this.buttons[0].height;return _1.height}
,isc.A.cellClick=function(_1,_2,_3){if(_1.click){if(isc.isA.String(_1.click))
...
this.$35i=isc.Button.create({left:this.getInnerWidth()-this.getScrollbarSize(),width:this.getScrollbarSize(),autoDraw:false,baseStyle:this.actionButtonStyle,skinImgDir:this.skinImgDir,icon:_1.src,showRollOverIcon:_1.showOver,showFocusedIcon:_1.showFocused,showFocusedAsOver:false,click:function(){this.parentElement.performAction()}});this.addChild(this.$35i);this.$35i.$sq(this)}
,isc.A.performAction=function(_1){if(this.actionType=="filter")this.performFilter(_1);else this.performSave(_1)}
,isc.A.performFilter=function(_1){var _2=this.getValues();_2=isc.DataSource.filterCriteriaForFormValues(_2);var _3={};if(_1)_3.showPrompt=false;this.sourceWidget.filterData(_2,null,_3)}
...
if(this.body)
this.body.setWidth(this.getInnerWidth()-this.getScrollbarSize())}
...
,isc.A.addItem=function(_1,_2){if(_2==null)_2=0;this.data.addAt(_1,_2);this.markForRedraw()}
...
_2.fields=_3}
var _5=_1.submenu;if(!_5){var _6=(this.$350||this),_7=(_6==this?0:this.$351);if(!_6.$352)_6.$352=[];this.logDebug("RootMenu:"+_6.getID()+", submenus:"+_6.$352+", Level:"+_7);_5=_6.$352[_7];if(!_5){isc.addProperties(_2,{ID:(_6.getID()+"_childrenSubMenu_"+_7),$350:_6,$351:_7+1,autoDraw:false,treeParentNode:this.$35k?_1:null,masterMenu:this});var _8=this.submenuConstructor||isc.Menu;_5=_8.create(_2);_6.$352[_7]=_5;_6.observe(_5,"destroy","observer.submenuDestroyed("+_7+");")}}else if(!isc.isA.Menu(_5)){if(isc.isA.String(_5)){_5=window[_5]}else if(isc.isAn.Array(_5)){_5=isc.Menu.create({autoDraw:false,data:_5},_2)}else if(isc.isAn.Object(_5)){_5=isc.Menu.create(isc.addProperties({autoDraw:false},_2,_5))}
_1.submenu=_5}
...
,isc.A.$35o=function(){var _1=isc.SB.create();if(this.enableIf)_1.append(this.enableIf,";");for(var i=0;i<this.data.length;i++){var _3=this.getItem(i);if(!_3)continue;if(_3.enableIf){_1.append("changed|=this.setItemEnabled(",i,",",_3.enableIf,");\r")}
...
,isc.A.setItemEnabled=function(_1,_2){_2=_2!=false;_1=this.getItem(_1);if(!_1)return;if(_1.enabled!=_2){_1.enabled=_2;this.markForRedraw("itemEnabled");return true}
return false}
,isc.A.setItemChecked=function(_1,_2){_2=_2!=false;_1=this.getItem(_1);if(!_1)return;if(_1.checked!=_2){_1.checked=_2;this.markForRedraw("itemChecked");return true}
return false}
