...
if(window[this.ID])window[this.ID]=null;isc.HiddenFrame.$h6.remove(this);var _1=this.getHandle();if(!_1)return;if(isc.Browser.isSafari)_1.location=isc.Page.getBlankFrameURL();var _2=eval("try{this.getHandle().name;true}catch(e){false}");if(!_2){this.logDebug("Can't dispose of "+this.ID+" - property access denied.");return}
...
_17[48]=(this.backgroundColor==null?null:";BACKGROUND-COLOR:"+this.backgroundColor);_17[49]=(this.backgroundImage==null?null:";BACKGROUND-IMAGE:url("+this.getImgURL(this.backgroundImage)+");BACKGROUND-REPEAT:"+this.backgroundRepeat);_17[50]=(_10?";-moz-box-sizing:border-box":null);var _13=this.getCurrentCursor();if(_13==_2.AUTO){_17[51]=_17[52]=null}else{_17[51]=_2.$r8;_17[52]=_13}
_17[53]=this.$r2();_17[54]=(this.padding!=null?";PADDING:"+this.padding+isc.px:null);_17[55]=(this.border?";BORDER:"+this.border:null);if(isc.Browser.isIE){_17[56]=(_11==null?null:";filter:progid:DXImageTransform.Microsoft.Alpha(opacity="+_11+")");if(this.$r9){_17[57]=";filter:progid:DXImageTransform.Microsoft.iris(irisStyle=circle)"}else{_17[57]=null}}else{if(_11!=null)
_17[56]=(_10?";-moz-opacity:":"opacity:")+_11}
...
);isc.evalBoundary;isc.B.push(isc.A.getInitialWidth=function(){return this.getWidth()}
...
{return false}}
return true}
);isc.evalBoundary;isc.B.push(isc.A.visibleAtPoint=function(_1,_2,_3,_4){if(isc.$cv)arguments.$cw=this;if(!this.containsPoint(_1,_2,_3)){return false}
...
this.adjustOverflow("setOverflow");if(_2==isc.Canvas.VISIBLE&&_1!=isc.Canvas.VISIBLE){var _7=Math.max(this.getScrollWidth()-this.getInnerWidth(),0),_8=Math.max(this.getScrollHeight()-this.getInnerHeight(),0);if(_7>0||_8>0)this.resized(-_7,-_8,"overflow changed")}else if(_2!=isc.Canvas.VISIBLE&&_1==isc.Canvas.VISIBLE){var _7=Math.max(this.getScrollWidth()-this.getInnerWidth(),0),_8=Math.max(this.getScrollHeight()-this.getInnerHeight(),0);if(_7>0||_8>0)this.resized(_7,_8,"overflow changed")}
...
return _1}
);isc.evalBoundary;isc.B.push(isc.A.getHoverTarget=function(_1,_2){var _3=this;while(_3){if(_3.getCanHover()==null){if(_3.prompt!=null)return _3;_3=_3.parentElement}else if(_3.getCanHover()){return _3}else{return null}}
return null}
...
isc.setAutoDraw=function(_1){if(_1==null)_1=true;isc.Canvas.addProperties({autoDraw:_1})};isc.A=isc.Canvas.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.drawRect=function(_1,_2,_3,_4,_5,_6,_7,_8){if(!this.$pz)this.$pz=[];this.$pz.add(isc.DrawRegion.getRectHTML(this,_1,_2,_3,_4,_6,_7,_8,_5))}
