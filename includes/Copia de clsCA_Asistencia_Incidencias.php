            ...
            if($num!=0){
                if($this->incidencia_codigo==11 || $this->incidencia_codigo==42 || $this->incidencia_codigo==166 ||
                    ...
                    $this->incidencia_codigo==151 || $this->incidencia_codigo==170 ||
                     $this->incidencia_codigo==79 || $this->incidencia_codigo==172 || $this->incidencia_codigo==176){
...
function Insertar_incidencia_horaria($ip_entrada){
    ...
    if($this->incidencia_codigo==157 || $this->incidencia_codigo==4 || $this->incidencia_codigo==67 || $this->incidencia_codigo == 42 || $this->incidencia_codigo==2 || $this->incidencia_codigo==79 || $this->incidencia_codigo == 166 || $this->incidencia_codigo == 176){
        ...
        $sql =" insert into ca_asistencia_incidencias ";
        $sql .=" (Empleado_codigo, Asistencia_Incidencia_Codigo,Asistencia_Codigo,Incidencia_Codigo,Responsable_Codigo,cod_campana,Tiempo_minutos,horas,minutos,fecha_reg,reg_automatico,area_codigo, area_codigo_responsable,ip_incidencia,supervisor_registra ) ";
        $sql .=" values(?,?,?,?,?,?,?,?,?,getdate(),?,?,?,?";
...
function Justificar_entrada_asistencia(){
    ...
    $rst = $cn->Execute($ssql);
    if (!$rst->EOF){
        if($this->incidencia_codigo == 42 || $this->incidencia_codigo == 79 || $this->incidencia_codigo == 166 || $this->incidencia_codigo == 176){ 
