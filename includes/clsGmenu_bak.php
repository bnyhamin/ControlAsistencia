...
function ListarEmpleadoAsistencia(){
    ...
    echo "</tr>";
    echo " </table>";
    echo "<table class='FormTABLA' id='idTabla' width=95% border=0 cellspacing=0 cellpadding=0 align=center style=font-size:12px >";
    /*echo "<tr>";
    ...
    $rs1 = $cn->Execute($ssql);
    if(!$rs1->EOF){	
        echo "<table id='idTabla1' width=95% border=0 cellspacing=0 cellpadding=0 align=center style=font-size:12px>";
        echo "<tr>";
    ...
    echo "<table class='FormTABLA' id='idTabla2' width=95% border=0 cellspacing=0 cellpadding=0 align=center style=font-size:12px >";
    echo "<tr>";
