...
Menu1=new Array("Registro Diario","javascript:nada()","",2,15,100);
	Menu1_1=new Array("Diario Gestion","javascript:Registrar_diario_onclick()","",0,15,100);
	Menu1_2=new Array("Posiciones del Dia","javascript:Registrar_posicion_onclick()","",0,15,100);
  
Menu2=new Array("Asistencias","javascript:nada()","",2,15,120);
	//Menu2_1=new Array("Justificacion Masiva","javascript:cmdJustificar_onclick()","",0,15,120);
	Menu2_1=new Array("Registro Masivo","javascript:cmdRegistrosBatch_onclick()","",0,15,120);
	Menu2_2=new Array("Extension De Turno","javascript:cmdExtensionTurno_onclick()","",0,15,120);
	//Menu2_4=new Array("Cambiar Turno","javascript:cmdCambiarTurno_onclick()","",0,15,120);

Menu3=new Array("Eventos","javascript:nada()","",1,15,80);
	Menu3_1=new Array("Aprobar","javascript:cmdAprobar_onclick()","",0,15,80);

Menu4=new Array("Biometrico Permisos","javascript:nada()","",1,15,120);
	Menu4_1=new Array("Ver Permisos","javascript:cmdVerPermisosPlataformas_onclick()","",0,15,80);
...
Menu3=new Array("Estados","javascript:nada()","",1);
	Menu3_1=new Array("Anular","javascript:cmdAnular_onclick() ","",0,15,80);
