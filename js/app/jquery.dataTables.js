	...
	$.fn.dataTableExt.oPagination = {
		...
		"two_button": {
			...
			"fnInit": function ( oSettings, fnCallbackDraw )
			{
				...
				oSettings.nPrevious.className = "paginate_enabled_previous"; // paginate_disabled_previous
				oSettings.nNext.className = "paginate_enabled_next"; // paginate_disabled_next
		...
		"full_numbers": {
			...
			"fnInit": function ( oSettings, fnCallbackDraw )
			{
				...
				nFirst.innerHTML = "<img src='css/ico/first.png' >"; // oSettings.oLanguage.oPaginate.sFirst; 
				nPrevious.innerHTML = "<img src='css/ico/previous.png' >"; //oSettings.oLanguage.oPaginate.sPrevious; 
				nNext.innerHTML = "<img src='css/ico/next.png' >"; // oSettings.oLanguage.oPaginate.sNext; 
				nLast.innerHTML = "<img src='css/ico/last.png' >"; // oSettings.oLanguage.oPaginate.sLast;
	...
	$.fn.dataTable = function( oInit )
	{
		...
		*/
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+' <b>Buscar:</b> <input class="txtbusqueda" type="text" value="'+
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = 
				'<select size="1" '+sName+' class="Select">'+
