...
if (isset($_GET["hddaccion"])){ 
    if ($_GET["hddaccion"]=="asignar"){
         ...
         //$arr_empleados   = explode(",",$_POST["hdempleados"]);
         $arr_empleados   = explode(",",$_POST["allempleadocodigo"]);
          
         $o->asignarEmpleadosPlataformas($arr_empleados, $arr_plataformas, $_POST['tipo_acceso'], $_POST['txtFechaInicio'], $_POST['txtFechaFin'], $_POST['observacion'], $_POST['permiso_activo'] );       
...
function guardar()
{   
    if(typeof(document.frm.allempleadocodigo) != 'undefined'){
        ...
        alert("Debe de haber al menos un Colaborador");
    }
...
<input type='hidden' name='hdempleados' id='hdempleados' value='<?php echo $_GET['ids']?>'/>
