          ...
          if (in_array($file_ext,$ext_permitidas)) {
                if( move_uploaded_file($archivo, $directorio.$nombrearchivo)){
                      ...
                      if(count($arr_empleados)){
                            $o->DesactivarEmpleadoPlataformas($arr_empleados, $arr_plataformas, $_POST['tipo_acceso'], $_POST['observacion'], $_POST['permiso_activo'],$nombrearchivo );
...
{   
        ...
        if (confirm("Confirme deshabilitar accesos plataforma ")){    
...
<body>
<center class="TITOpciones">Deshabilitar Acceso Masivo de empleados a plataformas</center>
...
<tr align='center'>
       <td colspan="2">
         	<input name='cmdGuarda' id='cmdGuarda' type='button' value='Deshabilitar' class='Button' style='width:70px' onclick='guardar()'/>
