...
<script type="text/javascript" src="js/bandeja.validador.js"/>
...
<form id="frm" name="frm" method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
   ...
   <tr>
       <td align="left" width="500" style="font-size: 13px;"><b>Validador&nbsp;:</b>&nbsp;&nbsp;<font color=#3366CC><b><?php echo $nombre_usuario;?></b></font></td>
  </tr>
  <tr>
       <td align="center" width="500" style="font-size: 13px;">
        <a href="javascript:PooBV.levanta_ventana('V')" style="text-decoration: none;color: #E17777; font-weight:600; font-size: 12px;" title="Consultar Eventos Registrados">
            Ver Eventos Registrados</a>&nbsp;
           <img src="../images/ico/search.png" alt="Consultar Eventos Registrados" border="0" onclick="javascript:PooBV.levanta_ventana('V')" height="16" width="16" style="cursor: hand;" />
       </td>
  </tr>
</table>
...
<tr>
    ...
    <td valign="top">
        ...
        ?>
        &nbsp;&nbsp;
        <button type="button" style="cursor:hand" title="Refresh" style="width:20px; height:21px" onclick="javascript:PooBV.actualizar();">
            <img src="../images/smyles/refresh.png" height="15">
        </button>&nbsp;&nbsp;
        <button type="button" style="cursor:hand" title="Salir" style="width:20px; height:21px" onclick="javascript:PooBV.salir();">
