...
$mensaje1=$ed->verifica_carga_requerimiento();
if ($mensaje1 != "OK"){
?>
    <script language="javascript">
        alert('¡ERROR! No se ha cargado el requerimiento de la semana respectiva');
        window.close();
    </script>
<?php			
}
$mensaje2=$ed->verifica_carga_disponibilidad();
if ($mensaje2 != "OK"){ 
?>
    <script language="javascript">
        alert('¡ERROR! No se ha generado disponibilidad de la semana respectiva');
        window.close();
    </script>
<?php
}

if($mensaje1=="OK" && $mensaje2=="OK" ){
    //$mensaje =$e->Generar_Programacion_Semanal();
    $mensaje =$e->Genera_Programacion_Automatica_Semanal();
    if ($mensaje=="OK"){
?>
    <script language="javascript">
...
<title>Generar Programacion</title>
...
<center><strong>Generar Programacion</strong></center>
