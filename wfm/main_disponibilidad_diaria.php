...
<title>Maestro de Disponibilidad Diaria - <?php echo SistemaNombre(); ?> </title>
<link rel="stylesheet" type="text/css" href="../../default.css">
<script language="JavaScript" src="../../default.js"></script>
</HEAD>
<body bgcolor='#ffffff' text='#000000' link='#000000' alink='#999999' vlink='#000000'   Class='PageBody'  >
<p class=TITOpciones>Maestro de Disponibilidad Diaria </p>
...
function cmdAdicionar_onclick() {
    self.location.href="disponibilidad_diaria.php?codigo=&pagina=<?php echo $npag ?>&buscam=<?php echo $buscam ?>&orden=<?php echo $orden ?>";
}
function cmdModificar_onclick() {
    var rpta=Registro();
    if (rpta != '' ) {
    self.location.href="disponibilidad_diaria.php?codigo=" + rpta + "&pagina=<?php echo $npag ?>&buscam=<?php echo $buscam ?>&orden=<?php echo $orden ?>";
    }
}
...
$objr->setMultipleSeleccion(false);
    ...
    $Campos[0] = "dd_codigo";
    $Campos[1] = "dd_codigo";
    $Campos[2] = "dd_identificador";
    $Campos[3] = "dd_descripcion";
    $Campos[4] = "case when dd_activo=1 then 'Si' else 'No' end";
    $objr->setAlias($Alias);
