...
<title>Detalle de Combinación</title>
...
<body>
<center><strong>DETALLE DE COMBINACIÓN</strong></center>
<br />
...
<table class="FormTable" width="100%"  border="0" cellspacing="1" cellpadding="0">
  <tr >
    ...
    <td  class="FieldCaptionTD" style="width:40px" align="center">Codigo_Sap</td>
  ...
  <?php
  		...
  		$er->mostrar_combinacion_empleado($fecha_inicio , $fecha_fin);
  ?>
</table>
