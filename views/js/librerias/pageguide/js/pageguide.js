...
tl.pg.init = function(preferences) {
    ...
    message.append('<a href="#" class="tlypageguide_close" title="Cerrar">Cerrar</a>')
      .append('<span></span>')
      .append('<div></div>')
    ...
    if (preferences.custom_open_button == null && $('.tlypageguide_toggle').length < 1) {
        jQuery('<div/>', {
          ...
          .append('<a href="#" class="tlypageguide_close" title="Cerrar Guia">Cerrar &raquo;</a>')
          .appendTo(wrapper);
    }
