...
<title>Seleccionar Incidencias</title>
...
//alert(cod);
var valor = window.showModalDialog("http://" + server + "/tmreportes/Gap/generar.jsp?anio=" + anio + "&mes=" + mes + "&area_codigo=" + area + "&campana=" + cod_campana + "&usuario_id=" + usuario + "&opcion=" + opcion + "&codigos=" + cod + "&responsable=0", "Reporte","dialogWidth:400px; dialogHeight:150px");
