...
if (isset($_GET["tiempo_efectivo"])) $tiempo_efectivo = $_GET["tiempo_efectivo"];
if (isset($_GET["extension_tiempo"])) $extension_tiempo = $_GET["extension_tiempo"];
